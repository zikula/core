...
function smarty_function_img($params, Zikula_View $view)
{
    ...
    if ($sysplugin) {
        ...
        $pluglangpath = "plugins/$osplugdir/Resources/public/images/$lang";
        $plugpath     = "plugins/$osplugdir/Resources/public/images";
        ...
        if ($modplugin) {
            ...
            $corethemepath = "themes/$ostheme/Resources/public/images";
