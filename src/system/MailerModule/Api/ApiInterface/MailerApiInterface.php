...
interface MailerApiInterface
{
     ...
     * @param string $body message body, if altbody is provided then this is the HTML version of the body
     * @param string $altBody alternative plain-text message body, if specified the mail will be sent as multipart/alternative
     * @param bool $html HTML flag, if altbody is not specified it indicates whether body contains HTML or not;
     *     otherwise this value is ignored, the body is assumed to be HTML, and the altbody is assumed to be plain text
     * @param array $headers custom headers to add - an array ['header' => 'content', 'header' => 'content']
     * @param array $attachments array of either absolute filenames to attach to the mail or array of arrays in format [$path, $filename, $encoding, $type]
