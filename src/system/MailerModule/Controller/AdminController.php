...
class AdminController extends AbstractController
{
    ...
    {
        @trigger_error('The zikulamailermodule_admin_index route is deprecated. please use zikulamailermodule_admin_config instead.', E_USER_DEPRECATED);

        return $this->redirect($this->generateUrl('zikulamailermodule_admin_config'));
    }
