...
class Admin_Admin extends Zikula_Controller
{
    ...
    public function newcat()
    {
        ...
        return $this->renderer->fetch('admin_admin_newcat.tpl');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            return $this->renderer->fetch('admin_admin_delete.tpl');
        }
    ...
    public function view($args = array())
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('admin_admin_view.tpl');
    }
    ...
    public function adminpanel($args)
    {
        ...
        // Return the output that has been generated by this function
        if ($this->renderer->template_exists('admin_admin_adminpanel_'.$cssfile[0].'.tpl')) {
            return $this->renderer->fetch('admin_admin_adminpanel_'.$cssfile[0].'.tpl');
        } else {
            return $this->renderer->fetch('admin_admin_adminpanel.tpl');
        }
    }
    ...
    public function modifyconfig()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('admin_admin_modifyconfig.tpl');
    }
    ...
    public function categorymenu($args)
    {
        ...
        // Return the output that has been generated by this function
        if ($this->renderer->template_exists('admin_admin_categorymenu_'.$cssfile[0].'.tpl')) {
            return $this->renderer->fetch('admin_admin_categorymenu_'.$cssfile[0].'.tpl');
        } else {
            return $this->renderer->fetch('admin_admin_categorymenu.tpl');
        }
    }
    ...
    public function help()
    {
        ...
        return $this->renderer->fetch('admin_admin_help.tpl');
    }
