...
class Admin_Admin extends Zikula_Controller
{
    ...
    public function newcat()
    {
        ...
        return $this->renderer->fetch('admin_admin_newcat.htm');
    }
    ...
    public function modify($args)
    {
        ...
        return $this->renderer->fetch('admin_admin_modify.htm');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            $this->renderer->assign('cid', $cid);
            return $this->renderer->fetch('admin_admin_delete.htm');
        }
    ...
    public function view($args = array())
    {
        ...
        $this->renderer->assign('pager', array('numitems' => ModUtil::apiFunc('Admin', 'admin', 'countitems'),
                    'itemsperpage' => $this->getVar('itemsperpage')));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('admin_admin_view.htm');
    }
    ...
    public function adminpanel($args)
    {
        ...
        if (!$this->getVar('ignoreinstallercheck') && System::getVar('development') == 0) {
            ...
            if ($zrcexists == true) {
                return $this->renderer->assign('zrcexists', $zrcexists)
                                      ->assign('adminpanellink', ModUtil::url('Admin','admin', 'adminpanel'))
                                      ->fetch('admin_admin_warning.htm');
            }
        }
        ...
        $this->renderer->assign('menu', $this->categorymenu(array('acid' => $acid)));
        ...
        $this->renderer->assign('modvars', ModUtil::getVar('Admin'));
        ...
        $this->renderer->assign('adminlinks', $adminlinks);
        ...
        // Return the output that has been generated by this function
        if ($this->renderer->template_exists('admin_admin_adminpanel_'.$cssfile[0].'.htm')) {
            return $this->renderer->fetch('admin_admin_adminpanel_'.$cssfile[0].'.htm');
        } else {
            return $this->renderer->fetch('admin_admin_adminpanel.htm');
        }
    }
    ...
    public function modifyconfig()
    {
        ...
        $this->renderer->assign('modulecategories', $modulecategories);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('admin_admin_modifyconfig.htm');
    }
    ...
    public function categorymenu($args)
    {
        ...
        $this->renderer->assign('currentcat', $acid);
        $this->renderer->assign('menuoptions', $menuoptions);
        ...
        $this->renderer->assign('notices', $notices);
        ...
        // Return the output that has been generated by this function
        if ($this->renderer->template_exists('admin_admin_categorymenu_'.$cssfile[0].'.htm')) {
            return $this->renderer->fetch('admin_admin_categorymenu_'.$cssfile[0].'.htm');
        } else {
            return $this->renderer->fetch('admin_admin_categorymenu.htm');
        }
    }
    ...
    public function help()
    {
        ...
        return $this->renderer->fetch('admin_admin_help.htm');
    }
