...
<div class="z-admincontainer z-form">
    ...
    <fieldset>
        ...
        <p>{gt text='After completing the installation process, it is very important to delete the Installer\'s file \'install.php\' and directory \'install\' from the site root directory, especially if it is on-line on the Internet, because otherwise there is an opportunity for a security breach. If the Security analyser detects this vulnerability, you will have to remove them before you can access the Administration panel. In addition, please consult the <a href="%s">security documentation</a> for more information about how to optimally configure a site from the security viewpoint.' tag1=$system_summary_link}</p>
