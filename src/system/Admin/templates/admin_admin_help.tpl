...
<div class="z-admincontainer z-form">
    <h2>{gt text="Help"}</h2>
    <fieldset>
        <legend>{gt text="Help page"}</legend>
        <h3 id="view">{gt text="Module categories list"}</h3>
        ...
        <h3 id="new">{gt text="Create new module category"}</h3>
        ...
        <h3 id="modifyconfig">{gt text="Settings"}</h3>
        ...
        <h3 id="generalsettings">{gt text="General settings"}</h3>
        ...
        <h3 id="displaysettings">{gt text="Display settings"}</h3>
        ...
        <h3 id="categoryconfiguration">{gt text="Modules categorisation"}</h3>
    ...
    <fieldset>
        ...
        <h4 id="admin_installwarning">{gt text="You see the message"}: {gt text="Stop, please! The installer file 'install.php' and directory 'install' are in the site root, but must be removed before you can access the site admin panel."}</h4>
        <p>{gt text='After completing the installation process, it is very important to delete the Installer\'s file \'install.php\' and directory \'install\' from the site root directory, especially if it is on-line on the Internet, because otherwise there is an opportunity for a security breach. If the Security analyser detects this vulnerability, you will have to remove them before you can access the Administration panel. In addition, please consult the <a href="%s">security documentation</a> for more information about how to optimally configure a site from the security viewpoint.' tag1=$system_summary_link|safetext}</p>

        <h4 id="admin_configphpwarning">{gt text="You see the message"}: {gt text="Configuration file 'config/config.php' is writeable, but should be read-only (chmod 400, 440 or at worst 444)."}</h4>
        <p>{gt text='When a site is originally installed, the Installer script creates a configuration file called \'config.php\' that is located in the sub-directory \'config\' within the site\'s root directory. It should not be left writeable, because this leaves an opportunity for a security breach. You should set the file\'s permissions to read-only (chmod 400, 440 or at worst 444). In addition, please consult the <a href="%s">security documentation</a> for more information about how to optimally configure a site from the security viewpoint.' tag1=$system_summary_link|safetext}</p>

        <h4 id="admin_upgrade_php_warning">{gt text="You see the message"}: {gt text="Installer file 'upgrade.php' is in the site root, but should be removed."}</h4>
        ...
        <h4 id="admin_magic_quotes_warning">{gt text="You see the message"}: {gt text="PHP 'magic_quotes_gpc' setting is ON, but should be OFF."}</h4>
        <p>{gt text='In some hosting environments, the PHP setting \'magic_quotes_gpc\' may be set to ON. However, this creates an opportunity for security breaches. If the site is accessible from the Internet, you are strongly recommended to ensure that \'magic_quotes_gpc\' is set to OFF. For instructions about how to do this, please consult the <a href="%s">security documentation</a>.' tag1=$system_summary_link|safetext}</p>

        <h4 id="admin_register_globals_warning">{gt text="You see the message"}: {gt text="PHP 'register_globals' setting is ON, but should be OFF."}</h4>
        <p>{gt text='In some hosting environments, the PHP setting \'register_globals\' may be set to ON. However, this can create an opportunity for security breaches. If the site is accessible from the Internet, you are strongly recommended to ensure that \'register_globals\' is set to OFF. For instructions about how to do this, please consult the <a href="%s">security documentation</a>.' tag1=$system_summary_link|safetext}</p>

        <h4 id="admin_ztemp_htaccess_warning">{gt text="You see the message"}: {gt text="There is no '.htaccess' file in the temporary directory ('/ztemp' or other location), but one should be present."}</h4>
        <p>{gt text='If properly installed, a site will include an \'.htaccess\' file in the site\'s temporary directory (which is called \'/ztemp\', unless another location is used). However, some methods used for transferring the package\'s files to a web space may lead to this file not being transferred. In this case, you are strongly recommended to create one (and to ensure that \'.htaccess\' files exist in certain other directories, too). For more information about this, please consult the <a href="%s">security documentation</a>.' tag1=$system_summary_link|safetext}</p>

        <h4 id="admin_phpids_warning">{gt text="You see the message"}: {gt text="PHPIDS with the Security Center is not activated, but preferably should be."}</h4>
        ...
        <h4 id="admin_idssoftblock_warning">{gt text="You see the message"}: {gt text="PHPIDS is activated, but requests are NOT blocked."}</h4>
        ...
        <h4 id="admin_security_center_warning2">{gt text="You see the message"}: {gt text="Security center module is not installed, but preferably should be."}</h4>
        ...
        <h4 id="admin_security_center_warning3">{gt text="You see the message"}: {gt text="Security center module is not activated, but preferably should be."}</h4>
        ...
        <h4 id="admin_legacymodewarning">{gt text="You see the message"}: {gt text="Legacy module support is enabled, but preferably should be disabled."}</h4>
