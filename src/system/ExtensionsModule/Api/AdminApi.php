...
class AdminApi extends \Zikula_AbstractApi
{
    ...
    public function upgradeall()
    {
        ...
        if ($this->listmodules(array('state' => ModUtil::STATE_UPGRADED))) {
            ...
            $priorities = array('ExtensionsModule', 'UsersModule' , 'GroupsModule', 'PermissionsModule', 'Admin', 'BlocksModule', 'ThemeModule', 'SettingsModule', 'Categories', 'SecurityCenterModule', 'ErrorsModule');
            $sortedList = array();
