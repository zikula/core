...
class ExtensionStateHelper
{
    ...
    {
        $this->dispatcher->dispatch(ExtensionEvents::UPDATE_STATE, new GenericEvent());
        ...
        if (isset($eventName)) {
            ...
            $event = new ModuleStateEvent($moduleBundle, ($moduleBundle === null) ? \ModUtil::getInfo($id) : null);
