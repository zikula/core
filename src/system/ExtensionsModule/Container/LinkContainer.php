...
class LinkContainer implements LinkContainerInterface
{
    ...
    private function getAdmin()
    {
        ...
        if ($this->permissionApi->hasPermission('ZikulaExtensionsModule::', '::', ACCESS_ADMIN)) {
            ...
            $links[] = array(
                'url' => $this->router->generate('zikulaextensionsmodule_admin_view'),
                'text' => $this->translator->__('Modules list'),
                'icon' => 'list',
                'links' => array(
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view'),
                        'text' => $this->translator->__('All')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_UNINITIALISED)),
                        'text' => $this->translator->__('Not installed')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_INACTIVE)),
                        'text' => $this->translator->__('Inactive')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_ACTIVE)),
                        'text' => $this->translator->__('Active')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_MISSING)),
                        'text' => $this->translator->__('Files missing')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_UPGRADED)),
                        'text' => $this->translator->__('New version uploaded')),
                    array('url' => $this->router->generate('zikulaextensionsmodule_admin_view', array('state' => ExtensionApi::STATE_INVALID)),
                        'text' => $this->translator->__('Invalid structure'))
                ));
            ...
            $links[] = array(
                'url' => $this->router->generate('zikulaextensionsmodule_admin_modifyconfig'),
