{gt text="Permission rules list" assign=templatetitle}
            ...
            <li id="permission_{$permission.permid}" class="{cycle values="z-odd,z-even"} z-sortable z-clearfix">
                <div id="permissioncontent_{$permission.permid}" class="permissioncontent">
                    ...
                    <span id="permdrag_{$permission.permid}" class="z-itemcell z-w05">
                        ...
                        <a href="{$permission.up.url|safetext}">{img src="1uparrow.gif" modname=core set=icons/extrasmall alt=$permission.up.title title=$permission.up.title}</a>
                        {/if}
                        {if $permission.arrows.down eq 1}
                        <a href="{$permission.down.url|safetext}">{img src="1downarrow.gif" modname=core set=icons/extrasmall alt=$permission.down.title title=$permission.down.title}</a>
                        {/if}
                        {/strip}
                    </span>
                    ...
                    <span id="permaction_{$permission.permid}" class="z-itemcell z-w07">
                        ...
                        <a id="modify_{$permission.permid}"     href="{$permission.editurl|safetext}" title="{gt text="Edit"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit" __alt="Edit"}</a>
                        ...
                        <button class="z-imagebutton z-hide tooltips" id="modifyajax_{$permission.permid}"   title="{gt text="Edit"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit" __alt="Edit"}</button>
                    ...
                    <span id="editpermaction_{$permission.permid}" class="z-itemcell z-w07 z-hide">
                        ...
                        <button class="z-imagebutton tooltips" id="permeditdelete_{$permission.permid}" title="{gt text="Delete"}">{img src=editdelete.gif modname=core set=icons/extrasmall __alt="Delete" __title="Delete"}</button>
            ...
            <li id="permission_1" class="z-hide z-clearfix">
                <div id="permissioncontent_1" class="permissioncontent">
                    ...
                    <span id="permaction_1" class="z-itemcell z-w07 z-hide">
                        <button class="z-imagebutton tooltips" id="modifyajax_1"   title="{gt text="Edit"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit" __alt="Edit"}</button>
                    ...
                    <span id="editpermaction_1" class="z-itemcell z-w07">
                        ...
                        <button class="z-imagebutton tooltips" id="permeditdelete_1" title="{gt text="Delete"}">{img src=editdelete.gif modname=core set=icons/extrasmall __alt="Delete" __title="Delete"}</button>
    ...
    <form id="testpermform" class="z-form" action="{modurl modname=permissions type=admin func=view}" method="post">
        <fieldset>
            ...
            <div class="z-buttons z-formbuttons">
                <button id="testpermsubmit" type="submit" title="{gt text="Check permission"}">{img modname=core src=button_ok.gif set=icons/extrasmall  __alt="Check permission" __title="Check permission"} {gt text="Check permission"}</button>
                <button class="z-hide" id="testpermsubmitajax" onclick="javascript:performpermissiontest(); return false;" title="{gt text="Check permission"}">{img modname=core src=button_ok.gif set=icons/extrasmall  __alt="Check permission" __title="Check permission"} {gt text="Check permission"}</button>
                <button id="testpermreset" type="reset" title="{gt text="Reset"}">{img modname=core src=button_cancel.gif set=icons/extrasmall  __alt="Reset" __title="Reset"} {gt text="Reset"}</button>
            </div>
        </fieldset>
    </form>
