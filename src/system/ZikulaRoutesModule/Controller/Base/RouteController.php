...
class RouteController extends Zikula_AbstractController
{
    ...
    public function displayAction(Request $request, RouteEntity $route)
    {
        ...
        if (!SecurityUtil::checkPermission($this->name . ':' . ucwords($objectType) . ':', $instanceId . '::', $permLevel)) {
            throw new AccessDeniedException();
        }
    ...
    public function handleSelectedEntriesAction(Request $request)
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new ModUrl($this->name, 'route', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
