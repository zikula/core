...
namespace Zikula\ExtensionsBundle\Twig\Runtime;
...
class UserInterfaceRuntime implements RuntimeExtensionInterface
{
    ...
    {
        $ref = new ControllerReference('Zikula\ExtensionsBundle\Controller\ExtensionsInterfaceController::footer');
    ...
    public function moduleHeader(
        ...
        $ref = new ControllerReference('Zikula\ExtensionsBundle\Controller\ExtensionsInterfaceController::header', [
            'type' => $type,
            'title' => $title,
            'titlelink' => $titleLink,
    ...
    public function moduleLinks(
        ...
        $ref = new ControllerReference('Zikula\ExtensionsBundle\Controller\ExtensionsInterfaceController::links', [
            'type' => $type,
            'links' => $links,
            'modname' => $modName,
            'menuid' => $menuId,
