...
namespace Zikula\ExtensionsBundle\Tests\Api\Fixtures;

use Doctrine\Common\Collections\Criteria;
use Zikula\ExtensionsBundle\Entity\ExtensionVarEntity;
use Zikula\ExtensionsBundle\Repository\ExtensionVarRepositoryInterface;
