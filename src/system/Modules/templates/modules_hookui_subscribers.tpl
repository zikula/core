...
<div class="z-admincontainer">
    ...
    {if count($hooksubscribers) > 0}
        ...
        <p class="z-informationmsg">{gt text='Click on the red circle next to each module to attach the provider. Likewise, click on the green circle to detach the provider.'}</p>
        ...
        <ol id="subscriberslist" class="z-itemlist">
            ...
            <span class="z-itemcell z-w40">{gt text='Status'}</span>
            </li>
