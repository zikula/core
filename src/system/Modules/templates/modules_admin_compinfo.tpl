...
<div class="z-admincontainer">
    ...
    <div class="z-buttons z-formbuttons">
        <a href="{modurl modname=Modules type=admin func=view startnum=$startnum letter=$letter state=$state}">{img modname=core src=button_ok.gif set=icons/small  __alt="Ok" __title="Ok"} {gt text="Ok"}</a>
    </div>
</div>
