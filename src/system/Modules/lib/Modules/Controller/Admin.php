...
class Modules_Controller_Admin extends Zikula_Controller
{
    ...
    public function modify()
    {
        ...
        return $this->view->fetch('modules_admin_modify.tpl');
    }
    ...
    public function view()
    {
        ...
        $state = FormUtil::getPassedValue('state', (!strstr(System::serverGetVar('HTTP_REFERER'), 'module='.$modinfo['name'])) ? null : SessionUtil::getVar('state', null), 'GETPOST');
        $sort = FormUtil::getPassedValue('sort', (!strstr(System::serverGetVar('HTTP_REFERER'), 'module='.$modinfo['name'])) ? null : SessionUtil::getVar('sort', null), 'GET');
        $sortdir = FormUtil::getPassedValue('sortdir', (!strstr(System::serverGetVar('HTTP_REFERER'), 'module='.$modinfo['name'])) ? null : SessionUtil::getVar('sortdir', null), 'GET');
...
//                                }
        ...
        $this->view->assign('pager', array('numitems' => ModUtil::apiFunc('Modules', 'admin', 'countitems', array('letter' => $letter, 'state' => $state)),
                                           'itemsperpage' => $this->getVar('itemsperpage')));

        // Return the output that has been generated by this function
        return $this->view->fetch('modules_admin_view.tpl');
    }
    ...
    public function remove()
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->view->fetch('modules_admin_remove.tpl');
        }
    ...
    public function hooks()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('modules_admin_hooks.tpl');
    ...
    public function extendedhooks()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('modules_admin_extendedhooks.tpl');
    ...
    public function compinfo()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('modules_admin_compinfo.tpl');
    }
    ...
    public function viewPlugins()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('modules_admin_viewPlugins.tpl');
    }
