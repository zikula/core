...
class Modules_Admin extends Zikula_Controller
{
    ...
    public function modify()
    {
        ...
        return $renderer->fetch('modules_admin_modify.htm');
    }
    ...
    public function view()
    {
        ...
        if ($GLOBALS['ZConfig']['Multisites']['multi'] != 1 || ($GLOBALS['ZConfig']['Multisites']['mainSiteURL'] == FormUtil::getPassedValue('siteDNS', null, 'GET') && $GLOBALS['ZConfig']['Multisites']['basedOnDomains'] == 0) || ($GLOBALS['ZConfig']['Multisites']['mainSiteURL'] == $_SERVER['HTTP_HOST'] && $GLOBALS['ZConfig']['Multisites']['basedOnDomains'] == 1)) {
            ...
            if (!(empty($inconsistencies['errors_modulenames']) && empty($inconsistencies['errors_displaynames']))) {
                $renderer->assign('errors_modulenames', $inconsistencies['errors_modulenames']);
                $renderer->assign('errors_displaynames', $inconsistencies['errors_displaynames']);

                return $renderer->fetch('modules_admin_regenerate_errors.htm');
            }
        ...
        $renderer->assign('multi', $GLOBALS['ZConfig']['Multisites']['multi']);

        $renderer->assign('modules', $moduleinfo);

        // Assign the values for the smarty plugin to produce a pager.
        $renderer->assign('pager', array(
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_view.htm');
    }
        ...
        if ($id != 0) {
            ...
            if (empty($confirmation) && $dependencies) {
                ...
                if (!empty($dependencies)) {
                    ...
                    $renderer->assign('dependencies', $dependencies);
                    $renderer->assign('modulenotfound', $modulenotfound);
                    return $renderer->fetch('modules_admin_initialise.htm');
                }
            } else {
    ...
    public function remove()
    {
        ...
        if (empty($confirmation)) {
            ...
            $blocks = ModUtil::apiFunc('Blocks', 'user', 'getall', array(
                    'modid' => $id));
            $renderer->assign('hasBlocks', count($blocks));

            $renderer->assign('dependents', $dependents);
            $renderer->assign('startnum', $startnum);
            $renderer->assign('letter', $letter);
            $renderer->assign('state', $state);

            // Return the output that has been generated by this function
            return $renderer->fetch('modules_admin_remove.htm');
        }
    ...
    public function hooks()
    {
        ...
        $renderer->assign('modinfo', $modinfo);
        ...
        $renderer->assign('hooks', $hooks);

        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_hooks.htm');
    ...
    public function extendedhooks()
    {
        ...
        $grouped_hooks = ModUtil::apiFunc('Modules', 'admin', 'getextendedmoduleshooks', array(
                'modid' => $id));
        $renderer->assign('grouped_hooks', $grouped_hooks);

        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_extendedhooks.htm');
    ...
    public function modifyconfig()
    {
        ...
        $renderer->assign(ModUtil::getVar('Modules'));

        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_modifyconfig.htm');
    }
    ...
    public function compinfo()
    {
        ...
        $renderer->assign('moduleInfo', $moduleInfo);
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_compinfo.htm');
    }
    ...
    public function viewPlugins()
    {
        ...
        $renderer->assign('state', $state);
        $renderer->assign('systemplugins', $systemplugins);

        // Return the output that has been generated by this function
        return $renderer->fetch('modules_admin_viewPlugins.htm');
    }
