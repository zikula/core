...
class Modules_Admin extends Zikula_Controller
{
    ...
    public function modify()
    {
        ...
        return $this->renderer->fetch('modules_admin_modify.htm');
    }
    ...
    public function view()
    {
        ...
        if ($GLOBALS['ZConfig']['Multisites']['multi'] != 1 || ($GLOBALS['ZConfig']['Multisites']['mainSiteURL'] == FormUtil::getPassedValue('siteDNS', null, 'GET') && $GLOBALS['ZConfig']['Multisites']['basedOnDomains'] == 0) || ($GLOBALS['ZConfig']['Multisites']['mainSiteURL'] == $_SERVER['HTTP_HOST'] && $GLOBALS['ZConfig']['Multisites']['basedOnDomains'] == 1)) {
            ...
            if (!(empty($inconsistencies['errors_modulenames']) && empty($inconsistencies['errors_displaynames']))) {
                ...
                return $this->renderer->fetch('modules_admin_regenerate_errors.htm');
            }
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('modules_admin_view.htm');
    }
            ...
            if (empty($confirmation) && $dependencies) {
                ...
                if (!empty($dependencies)) {
                    return $this->renderer->assign('id', $id)
                                          ...
                                          ->fetch('modules_admin_initialise.htm');
                }
            } else {
    ...
    public function remove()
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->renderer->fetch('modules_admin_remove.htm');
        }
    ...
    public function hooks()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('modules_admin_hooks.htm');
    ...
    public function extendedhooks()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('modules_admin_extendedhooks.htm');
    ...
    public function modifyconfig()
    {
        ...
        return $this->renderer->assign(ModUtil::getVar('Modules'))
                              ->fetch('modules_admin_modifyconfig.htm');
    }
    ...
    public function compinfo()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('modules_admin_compinfo.htm');
    }
    ...
    public function viewPlugins()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('modules_admin_viewPlugins.htm');
    }
