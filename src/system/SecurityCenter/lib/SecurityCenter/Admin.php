...
class SecurityCenter_Admin extends Zikula_Controller
{
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            $renderer->assign('hid', $hid);
            return $renderer->fetch('securitycenter_admin_delete.htm');
        }
    ...
    public function view($args = array())
    {
        ...
        $renderer->assign('hackattempts', $hackattempts);
    ...
    public function modifyconfig()
    {
        ...
        return $renderer->fetch('securitycenter_admin_modifyconfig.htm');
    }
...
//echo "\r\n\r\n<pre>" . print_r($config, true) . "</pre>\r\n\r\n";
    ...
    public function display($args)
    {
        ...
        $renderer->assign('title', strtoupper($arraytype));
        ...
        $renderer->assign('arrayvariables', $arrayvariables);

        return $renderer->fetch('securitycenter_admin_display.htm');
    }
    ...
    public function viewobj()
    {
        ...
        return $renderer->fetch('securitycenter_admin_view_' . DataUtil::formatForOS($ot) . '.htm');
    }
    ...
    public function allowedhtml($args)
    {
        ...
        $renderer->assign('htmltags', $this->_gethtmltags());
        $renderer->assign('currenthtmltags', System::getVar('AllowableHTML'));
        $renderer->assign('htmlentities', System::getVar('htmlentities'));

        // check for HTML Purifier outputfilter
        $htmlpurifier = (bool) (System::getVar('outputfilter') == 1);
        $renderer->assign('htmlpurifier', $htmlpurifier);
        $renderer->assign('configurl', ModUtil::url('SecurityCenter', 'admin', 'modifyconfig'));

        return $renderer->fetch('securitycenter_admin_allowedhtml.htm');
    }
