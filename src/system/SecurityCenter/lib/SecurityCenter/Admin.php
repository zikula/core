...
class SecurityCenter_Admin extends Zikula_Controller
{
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            return $this->renderer->fetch('securitycenter_admin_delete.htm');
        }
    ...
    public function view($args = array())
    {
        ...
        return $this->renderer->fetch('securitycenter_admin_view.htm');
    }
    ...
    public function modifyconfig()
    {
        ...
        return $this->renderer->fetch('securitycenter_admin_modifyconfig.htm');
    }
    ...
    public function purifierconfig()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('securitycenter_admin_purifierconfig.htm');
    }
...
//echo "\r\n\r\n<pre>" . print_r($config, true) . "</pre>\r\n\r\n";
    ...
    public function display($args)
    {
        ...
        return $this->renderer->fetch('securitycenter_admin_display.htm');
    }
    ...
    public function viewobj()
    {
        ...
        return $this->renderer->fetch('securitycenter_admin_view_' . DataUtil::formatForOS($ot) . '.htm');
    }
    ...
    public function allowedhtml($args)
    {
        ...
        return $this->renderer->fetch('securitycenter_admin_allowedhtml.htm');
    }
