...
//echo "\r\n\r\n<pre>" . print_r($config, true) . "</pre>\r\n\r\n";
    ...
    public function viewidslogAction()
    {
        ...
        $items = ModUtil::apiFunc('SecurityCenter', 'admin', 'getAllIntrusions', $item_params);
        ...
        $pager = array();
        $pager['numitems'] = ModUtil::apiFunc('SecurityCenter', 'admin', 'countAllIntrusions', $item_params);
