...
class SecurityCenter_Controller_AdminController extends Zikula_AbstractController
{
    ...
    public function modifyconfigAction()
    {
        ...
        return $this->response($this->view->fetch('securitycenter_admin_modifyconfig.tpl'));
    }
    ...
    public function purifierconfigAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('securitycenter_admin_purifierconfig.tpl'));
    }
...
//echo "\r\n\r\n<pre>" . print_r($config, true) . "</pre>\r\n\r\n";
    ...
    public function exportidslogAction()
    {
        ...
        // fetch output from template
        return $this->response($this->view->fetch('securitycenter_admin_exportidslog.tpl'));
    }
    ...
    public function purgeidslogAction()
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->response($this->view->fetch('securitycenter_admin_purgeidslog.tpl'));
        }
    ...
    public function allowedhtmlAction($args)
    {
        ...
        return $this->response($this->view->fetch('securitycenter_admin_allowedhtml.tpl'));
    }
