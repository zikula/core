    ...
    <form class="z-form" action="{modurl modname="Categories" type="adminform" func="preferences"}" method="post" enctype="application/x-www-form-urlencoded">
        <div>
            ...
            <div class="z-buttons z-formbuttons">
                ...
                <a href="{modurl modname="Categories" type="admin" func="preferences"}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.gif set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            </div>
        </div>
    </form>
</div>
