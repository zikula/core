...
class GroupEvents
{
     ...
     */
    public const GROUP_PRE_DELETE = 'group.pre_delete';
     ...
     */
    public const GROUP_APPLICATION_PROCESSED = 'group.application.processed';

    /**
     * Occurs after the successful creation of a group application. The subject is the GroupApplicationEntity.
     */
    public const GROUP_NEW_APPLICATION = 'group.application.new';
}
