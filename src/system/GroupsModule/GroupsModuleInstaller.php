...
class GroupsModuleInstaller extends \Zikula_AbstractInstaller
{
    ...
    public function install()
    {
        // create tables
        $classes = array(
            'GroupsModule\Entity\GroupEntity',
            'GroupsModule\Entity\GroupMembershipEntity',
            'GroupsModule\Entity\GroupApplicationEntity'
        );
    ...
    public function defaultdata()
    {
        ...
        foreach ($records as $record) {
            $item = new \GroupsModule\Entity\GroupEntity;
        ...
        foreach ($records as $record) {
            $item = new \GroupsModule\Entity\GroupMembershipEntity;
            $item['gid'] = $record['gid'];
            $item['uid'] = $record['uid'];
            $this->entityManager->persist($item);
        }
