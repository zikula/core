...
class AdminController extends \Zikula_AbstractController
{
    ...
    public function mainAction()
    {
        ...
        return $this->redirect(ModUtil::url('GroupsModule', 'admin', 'view'));
    }
        ...
        foreach ($items as $item) {
            ...
            if (SecurityUtil::checkPermission('Groups::', $item['gid'].'::', ACCESS_READ)) {
                ...
                if (SecurityUtil::checkPermission('Groups::', $item['gid'].'::', ACCESS_EDIT)) {
                    ...
                    $membersurl = ModUtil::url('GroupsModule', 'admin', 'groupmembership', array('gid'     => $item['gid']));

                    $options[] = array('url' => ModUtil::url('GroupsModule', 'admin', 'modify', array('gid'     => $item['gid'])),
                            'title'   => $this->__('Edit'),
                            'imgfile' => 'xedit.png');
                    ...
                    $options[] = array('url' => ModUtil::url('GroupsModule', 'admin', 'groupmembership', array('gid'     => $item['gid'])),
    ...
    public function createAction(array $args = array())
    {
        ...
        $check = ModUtil::apiFunc('GroupsModule', 'admin', 'getgidbyname', array());
        ...
        if (is_array($users) && SecurityUtil::checkPermission('Groups::', $group['gid'].'::', ACCESS_EDIT)) {
            foreach ($users as $user) {
                ...
                if (($user['uid'] == $currentUid)
                    ...
                    $options[] = array(
                        'url'     => ModUtil::url('GroupsModule', 'admin', 'removeuser', array('gid' => $group['gid'], 'uid' => $user['uid'])),
    ...
    public function adduserAction(array $args = array())
    {
        ...
        // This function generated no output
        return $this->redirect(ModUtil::url('GroupsModule', 'admin', 'groupmembership', array('gid' => $gid)));
    }
    ...
    public function userpendingAction()
    {
        ...
        if (empty($gid) || empty($userid)) {
            return LogUtil::registerArgsError(ModUtil::url('GroupsModule', 'admin', 'view'));
        }
