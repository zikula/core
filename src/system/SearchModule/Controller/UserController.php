...
class UserController extends \Zikula_AbstractController
{
    ...
    public function mainAction()
    {
        ...
        return $this->redirect(ModUtil::url('SearchModule', 'user', 'form'));
    }
    ...
    public function searchAction()
    {
        ...
        if (empty($vars['q'])) {
            ...
            $this->redirect(ModUtil::url('SearchModule', 'user', 'form'));
        }
        ...
        $lifetime = ModUtil::getVar('ThemeModule', 'render_lifetime');
