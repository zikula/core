...
class SearchController extends AbstractController
{
    ...
    public function executeAction(Request $request, $page = -1)
    {
        ...
        foreach ($core14searchableModules as $searchableModule) {
            ...
            $active = !$setActiveDefaults || (isset($activeModules[$searchableModule['name']]) && ($activeModules[$searchableModule['name']] == 1));
        ...
        if ($request->isMethod('GET') && !empty($q = $request->query->get('q', ''))) {
