...
class AdminController extends \Zikula_AbstractController
{
     ...
     *
     * See also the definition of {@link \Zikula\UsersModule\Controller\FormData\ModifyUserForm}.
     *
     * @return Response symfony response object containing the rendered template.
     *
...
//        $reginfo = ModUtil::apiFunc($this->name, 'registration', 'get', array('uid' => $uid));
     ...
     *                          otherwise not present.
     *
     * See also the definition of {@link \Zikula\UsersModule\Controller\FormData\ModifyRegistrationForm}.
     *
...
//            ));
     ...
     * Parameters passed via POST:
     * ---------------------------
     * See the definition of {@link \Zikula\UsersModule\Controller\FormData\ConfigForm}.
     *
     * @return Response symfony response object
     *
