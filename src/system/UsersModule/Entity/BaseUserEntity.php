 ...
 * User entity class.
 *
 * @todo This class is marked as MappedSuperClass in order to maintain BC with psr-0 namespaces
 * @see \Zikula\UsersModule\Entity\UserEntity
 * @todo at Core-2.0 do the following:
 *  1. rename this class to simply `UserEntity`
 *  2. remove MappedSuperClass annotation and copy annotations from above referenced class to this
 *  3. change `$attributes` property to private (see note inline)
 ...
 */
class BaseUserEntity extends EntityAccess
{
    /**
