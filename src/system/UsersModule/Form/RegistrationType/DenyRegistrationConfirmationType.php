...
class DenyRegistrationConfirmationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('user', 'Symfony\Component\Form\Extension\Core\Type\HiddenType')
            ->add('notify', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', [
                'label' => $options['translator']->__('Notify the applicant via e-mail'),
                'required' => false
            ])
            ->add('reason', 'Symfony\Component\Form\Extension\Core\Type\TextareaType', [
                'label' => $options['translator']->__('Reason'),
                'required' => false
            ])
    ...
    {
        return 'zikulausersmodule_denyregistrationconfirmation';
    }
