...
class UserApi extends \Zikula_AbstractApi
{
    ...
    public function getAll($args)
    {
        ...
        $qb->select('u')
           ->from('UsersModule\Entity\UserEntity', 'u');
    ...
    public function mailConfirmationCode($args)
    {
        ...
        if ($user) {
            ...
            if ($hashedConfirmationCode !== false) {
                ...
                $codeSaved = new \UsersModule\Entity\UserVerificationEntity;
    ...
    public function checkConfirmationCode($args)
    {
        ...
        if (!$user) {
            ...
            $verifychgObj = $this->entityManager->getRepository('UsersModule\Entity\UserVerificationEntity')->findOneBy(array('uid' => $user['uid'], 'changetype' => UsersConstant::VERIFYCHGTYPE_PWD));
            if ($verifychgObj) {
    ...
    public function savePreEmail($args)
    {
        ...
        $obj = new \UsersModule\Entity\UserVerificationEntity;
    ...
    public function getUserPreEmail()
    {
        ...
        $item = $this->entityManager->getRepository('UsersModule\Entity\UserVerificationEntity')->findOneBy(array('uid' => $uid, 'changetype' => UsersConstant::VERIFYCHGTYPE_EMAIL));
