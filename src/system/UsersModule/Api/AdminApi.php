...
class AdminApi extends \Zikula_AbstractApi
{
    ...
    public function findUsers($args)
    {
        ...
        $dql = "SELECT u FROM UsersModule\Entity\UserEntity u $where ORDER BY u.uname ASC";
    ...
    public function deleteUser($args)
    {
        ...
        foreach ($userList as $userObj) {
            if ($markOnly) {
                ...
                $dql = "DELETE FROM GroupsModule\Entity\GroupMembershipEntity m WHERE m.uid = {$userObj['uid']}";
                $query = $this->entityManager->createQuery($dql);
                $query->getResult();
                ...
                // delete session
                $dql = "DELETE FROM UsersModule\Entity\UserEntity u WHERE u.uid = {$userObj['uid']}";
                $query = $this->entityManager->createQuery($dql);
                $query->getResult();
    ...
    public function checkMultipleExistence($args)
    {
        ...
        $dql = "SELECT u FROM UsersModule\Entity\UserEntity u WHERE u.$key IN ('" . implode("', '", $valuesArray) . "')";
        $query = $this->entityManager->createQuery($dql);
