...
{route name='zikulausersmodule_user_verifyregistration' uname=$reginfo.uname verifycode=$verifycode|urlencode absolute=true assign='verificationurl'}
...
{if $approvalorder == 'Zikula\UsersModule\Constant::APPROVAL_AFTER'|const}{gt text="We will not be able to approve your request until after you have completed this verification step."}{/if}
