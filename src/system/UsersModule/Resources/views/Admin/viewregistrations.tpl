        ...
        <tr>
            ...
            {if isset($regactions.modify)}
                {if $regactions.modify}
                    <a class="fa fa-pencil-square-o fa-fw tooltips" href="{route name='zikulausersmodule_registration_modify' user=$reginfo.uid}" title="{gt text='Modify registration details'}"></a>
                {else}
