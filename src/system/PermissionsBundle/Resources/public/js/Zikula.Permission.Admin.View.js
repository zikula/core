...
(function ($) {
    ...
    function editPermissionHandler(event) {
        ...
        $.ajax({
            type: 'POST',
            url: Routing.generate('zikulapermissionsbundle_permission_edit', {pid: id}),
            data: pars
        }).done(function (data) {
            var modal = $('#editModal');
    ...
    function savePermission() {
        var pid = $('#zikulapermissionsbundle_permission_pid').val();
        if ('' === pid) {
            pid = '-1';
        ...
        $.ajax({
            type: 'POST',
            url: Routing.generate('zikulapermissionsbundle_permission_edit', {
                pid: pid
            }),
            data: pars
        }).done(function (data) {
            if (data.view) {
                ...
                if (pid !== '-1') {
                    ...
                    $('#permission-group-' + pid).text($('#zikulapermissionsbundle_permission_gid').find('option:selected').text());
                    $('#permission-level-' + pid).data('id', data.permission.level);
                    $('#permission-level-' + pid).text($('#zikulapermissionsbundle_permission_level').find('option:selected').text());
                } else {
    ...
    function deletePermission() {
        $.ajax({
            url: Routing.generate('zikulapermissionsbundle_permission_delete', {pid: currentDelete.data('id')}),
            type: 'POST'
        }).done(function () {
    ...
    function startTestPermission(event) {
        ...
        $('#zikulapermissionsbundle_permissioncheck_user').val('');
        $('#zikulapermissionsbundle_permissioncheck_component').val($('#permission-component-' + pid).text());
        $('#zikulapermissionsbundle_permissioncheck_instance').val($('#permission-instance-' + pid).text());
    ...
    $(document).ready(function () {
        ...
        $sortable.sortable({
            ...
            update: function (event, ui) {
                ...
                $.ajax({
                    url: Routing.generate('zikulapermissionsbundle_permission_changeorder'),
                    dataType: 'json',
                    type: 'POST',
                    data: {
        ...
        $('#zikulapermissionsbundle_permissioncheck_check').click(function (event) {
            event.preventDefault();
            ...
            $.ajax({
                url: Routing.generate('zikulapermissionsbundle_permission_test'),
                dataType: 'json',
                type: 'POST',
                data: pars
            }).done(function (data) {
        ...
        $('#zikulapermissionsbundle_permissioncheck_reset').click(function (event) {
            event.preventDefault();
            $('#zikulapermissionsbundle_permissioncheck_user').val('');
            $('#zikulapermissionsbundle_permissioncheck_component').val('');
            $('#zikulapermissionsbundle_permissioncheck_instance').val('');
        });
        ...
        /* --- Filter permissions ------------------------------------------------------------------------------------------- */
        $('#zikulapermissionsbundle_filterlist_filterGroup, #zikulapermissionsbundle_filterlist_filterComponent, #zikulapermissionsbundle_filterlist_filterColour').change(function () {
            var group = $('#zikulapermissionsbundle_filterlist_filterGroup').val();
            var component = $('#zikulapermissionsbundle_filterlist_filterComponent').val();
            var colour = $('#zikulapermissionsbundle_filterlist_filterColour').val();
        ...
        $('#zikulapermissionsbundle_filterlist_reset').click(function () {
            $('#zikulapermissionsbundle_filterlist_filterComponent').val(-1);
            $('#zikulapermissionsbundle_filterlist_filterGroup').val(-1).trigger('change');
            $('#zikulapermissionsbundle_filterlist_filterColour').val(-1);
        });
