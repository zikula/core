...
abstract class AbstractRouteType extends AbstractType
{
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options = []): void
    {
        ...
        $builder->add($builder->create('defaults', ArrayType::class, [
            ...
            'attr' => [
                'class' => '',
                'title' => 'Enter the defaults of the route.',
            ],
            'required' => false,
        ])->addModelTransformer(new NullToEmptyTransformer()));
        $builder->add($builder->create('requirements', ArrayType::class, [
            'label' => 'Requirements:',
            'help' => 'Enter one entry per line.',
            'empty_data' => [],
            'attr' => [
                'class' => '',
                'title' => 'Enter the requirements of the route.',
            ],
            'required' => false,
        ])->addModelTransformer(new NullToEmptyTransformer()));
        $builder->add($builder->create('options', ArrayType::class, [
            'label' => 'Options:',
            'help' => 'Enter one entry per line.',
            'empty_data' => [],
            'attr' => [
                'class' => '',
                'title' => 'Enter the options of the route.',
            ],
            'required' => false,
        ])->addModelTransformer(new NullToEmptyTransformer()));
