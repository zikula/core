...
<form class="z-form htmlpure" action="{modurl modname='ZikulaSecurityCenterModule' type='admin' func='updatepurifierconfig'}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-buttons z-formbuttons">
                ...
                <a href="{modurl modname='ZikulaSecurityCenterModule' type='admin' func="main"}" title="{gt text="Cancel"}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text="Cancel"}</a>
                <a href="{modurl modname='ZikulaSecurityCenterModule' type='admin' func='purifierconfig' reset='default'}" title="{gt text="Reset to Default Values"}">{img modname='core' src='reload.png' set='icons/extrasmall' __alt='Reset to Default Values' __title='Reset to Default Values'} {gt text="Reset to Default Values"}</a>
            </div>
        </div>
    </form>
    {adminfooter}