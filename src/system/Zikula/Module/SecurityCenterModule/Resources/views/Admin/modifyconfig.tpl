...
{pageaddvar name="javascript" value="system/Zikula/Module/SecurityCenterModule/Resources/public/js/securitycenter_admin_modifyconfig.js"}
{pageaddvarblock}
    ...
    <div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <p id="securitycenter_sitesecureurl_container" class="help-block alert alert-info">{gt text="Notice: If you use a different host name for HTTPS secure sessions and you insert an address in the 'Secure host name' box, make sure you include a trailing slash at the end of the address."}</p>
            </div>
        </div>
        </fieldset>
        <fieldset>
            ...
            <div id="securitycenter_signingkey_container" class="form-group">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <p id="securitycenter_wheretosavesessionswarning_container" class="help-block alert alert-info">{gt text="Notice: If you change this setting, you will be logged-out immediately and will have to log back in again."}</p>
                </div>
            </div>

            <div id="securitycenter_sessionsavepath_container" class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <p id="securitycenter_sessionfilessavepathwarning_container" class="help-block alert alert-info">{gt text="Notice: If you change 'Where to save sessions' to 'File' then you must enter a path in the 'Path for saving session files' box above. The path must be writeable."}</p>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <p id="securitycenter_sessioncsrftokenonetime_container" class="help-block alert alert-info">{gt text="One time CSRF protection may affect the browser back button but it more secure."}</p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <p id="securitycenter_sessionnamewarning_container" class="help-block alert alert-warning">{gt text="Notice: If you change the 'Session cookie name' setting, all registered users who are currently logged-in will then be logged-out automatically, and they will have to log back in again."}</p>
            </div>
        </div>
        </fieldset>
