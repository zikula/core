...
{if ($category)}
<form class="z-form" action="{modurl modname="ZikulaCategoriesModule" type="userform" func="edit"}" method="post" enctype="application/x-www-form-urlencoded">
    {else}
    <form class="z-form" action="{modurl modname="ZikulaCategoriesModule" type="userform" func="newcat"}" method="post" enctype="application/x-www-form-urlencoded">
        {/if}
        <fieldset>
        ...
        <div class="z-buttons z-formbuttons">
            ...
            <a href="{modurl modname=ZikulaCategoriesModule type=user func=edit dr=$rootCat.id}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.png set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            {else}
            {button src=button_ok.png set=icons/extrasmall __alt="Save" __title="Save" __text="Save"}
            {/if}
        </div>
