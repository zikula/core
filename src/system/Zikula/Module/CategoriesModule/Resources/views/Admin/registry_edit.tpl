        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <a class="icon-pencil tooltips" href="{modurl modname='ZikulaCategoriesModule' type='admin' func='editregistry' id=$obj.id}" title="{gt text='Edit'}" ></a>
                        <a class="icon-trash tooltips" href="{modurl modname='ZikulaCategoriesModule' type='admin' func='deleteregistry' id=$obj.id}" title="{gt text='Delete'}"></a>
                    </td>
                    {/if}
                </tr>
                {/foreach}
