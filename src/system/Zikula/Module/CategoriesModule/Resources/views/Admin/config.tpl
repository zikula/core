...
<form class="form-horizontal" role="form" action="{route name="zikulacategoriesmodule_adminform_rebuild_paths"}" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
