...
<form class="z-form" action="{modurl modname="ZikulaCategoriesModule" type="adminform" func="rebuild_paths"}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-buttons z-formbuttons">
                ...
                <a class="z-btred" href="{modurl modname=ZikulaCategoriesModule type=admin func=index}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.png set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            </div>
        </fieldset>
    </div>
</form>
