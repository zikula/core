...
{if $mode == "edit"}
    ...
    <form class="z-form" action="{modurl modname="ZikulaCategoriesModule" type="adminform" func="edit"}" method="post" enctype="application/x-www-form-urlencoded">
{else}
    <div id="top" class="z-admin-content-pagetitle">
        {icon type="new" size="small"}
        <h3>{gt text="Create new category"}</h3>
    </div>
    <form class="z-form" action="{modurl modname="ZikulaCategoriesModule" type="adminform" func="newcat"}" method="post" enctype="application/x-www-form-urlencoded">
{/if}
    <fieldset>
