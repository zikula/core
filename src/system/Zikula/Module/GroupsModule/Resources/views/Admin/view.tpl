...
<br />
<a id="appendajax" {*onclick="groupappend();"*} title="{gt text="Create new group"}" href="{modurl modname='ZikulaGroupsModule' type='admin' func='newgroup'}"><span class="fa fa-plus-sign"></span> {gt text="Create new group"}</a>
<br /><br />
    ...
    <tbody>
        ...
        <tr id="group_{$group.gid}">
            ...
            <td id="groupaction_{$group.gid}" class="actions">
                ...
                <a href="{$group.membersurl|safetext}" class="fa fa-group tooltips" title="{gt text="Group membership"}"></a>
