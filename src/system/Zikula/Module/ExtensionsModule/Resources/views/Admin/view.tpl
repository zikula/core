...
<table class="table table-bordered table-striped">
    <thead>
        <tr>
            <th>
                {sortlink __linktext='Internal name' sort='name' currentsort=$sort sortdir=$sortdir route='zikulaextensionsmodule_admin_view'}
            </th>
            <th>
                {sortlink __linktext='Display name' sort='displayname' currentsort=$sort sortdir=$sortdir route='zikulaextensionsmodule_admin_view'}
            </th>
