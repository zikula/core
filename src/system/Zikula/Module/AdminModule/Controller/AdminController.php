...
class AdminController extends \Zikula_AbstractController
{
    ...
    public function viewAction($args = array())
    {
        ...
        return new Response($this->view->fetch('admin_admin_view.tpl'));
    }
    ...
    public function newcatAction()
    {
        ...
        // Return the output that has been generated by this function
        return new Response($this->view->fetch('admin_admin_newcat.tpl'));
    }
    ...
    public function modifyAction($args)
    {
        ...
        return new Response($this->view->fetch('admin_admin_modify.tpl'));
    }
    ...
    public function adminpanelAction($args)
    {
        ...
        foreach ($adminmodules as $adminmodule) {
            if (SecurityUtil::checkPermission("{$adminmodule['name']}::", 'ANY', ACCESS_EDIT)) {
                ...
                if (($catid == $acid) || (($catid == false) && ($acid == $this->getVar('defaultcategory')))) {
                    ...
                    $menutexturl = $this->get('router')->generate('zikulaadminmodule_admin_index');
        ...
        return new Response($this->view->fetch('admin_admin_adminpanel.tpl'));
    }
    ...
    public function modifyconfigAction()
    {
        ...
        // Return the output that has been generated by this function
        return new Response($this->view->fetch('admin_admin_modifyconfig.tpl'));
    }
    ...
    public function categorymenuAction($args)
    {
        ...
        return new Response($this->view->fetch('admin_admin_categorymenu.tpl'));
    }
    ...
    {
        return new Response($this->view->fetch('admin_admin_header.tpl'));
    }
    ...
    {
        return new Response($this->view->fetch('admin_admin_footer.tpl'));
    }
    ...
    public function helpAction()
    {
        ...
        return new Response($this->view->fetch('admin_admin_help.tpl'));
    }
