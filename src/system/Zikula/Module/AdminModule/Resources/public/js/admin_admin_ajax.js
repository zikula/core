...
Zikula.AdminPanel.Tab = Class.create(/** @lends Zikula.AdminPanel.Tab.prototype */{
    ...
    attachEditor: function() {
        var link = this.tab.down('a'),
            tabKlass = this;
        this.editor = new Ajax.InPlaceEditor(link, 'index.php?module=adminpanel&type=ajax&func=editCategory', {
    ...
    deleteTab: function() {
        ...
        new Zikula.Ajax.Request("index.php?module=adminpanel&type=ajax&func=deleteCategory", {
            parameters: pars,
    ...
    setTabDefault: function() {
        ...
        new Zikula.Ajax.Request("index.php?module=adminpanel&type=ajax&func=defaultCategory", {
            parameters: pars,
...
Object.extend(Zikula.AdminPanel.Tab, /** @lends Zikula.AdminPanel.Tab */{
        ...
        Sortable.create('admintabs', {
            ...
            onUpdate: function(sortable) {
                ...
                new Zikula.Ajax.Request(
                    'index.php?module=adminpanel&type=ajax&func=sortCategories', {
                        parameters: pars,
    ...
    addTabSave: function(event) {
        ...
        new Zikula.Ajax.Request("index.php?module=adminpanel&type=ajax&func=addCategory", {
            parameters: pars,
...
Zikula.AdminPanel.Module = Class.create(/** @lends Zikula.AdminPanel.Module.prototype */{
    ...
    move: function(tab) {
        ...
        new Zikula.Ajax.Request("index.php?module=adminpanel&type=ajax&func=changeModuleCategory", {
            parameters: pars,
    ...
    setupSortable: function() {
        ...
        Sortable.create('modules', {
            ...
            onUpdate: function(element) {
                ...
                new Zikula.Ajax.Request('index.php?module=adminpanel&type=ajax&func=sortModules', {
                    parameters: pars,
                    onComplete: function(response) {
                        if (!response.isSuccess()) {
                            Zikula.showajaxerror(response.getMessage());
