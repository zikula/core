...
<form class="z-form" action="{modurl modname="ZikulaAdminModule" type="admin" func="updateconfig"}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                <input id="admin_itemsperpage" name="modvars[itemsperpage]" type="text" size="3" maxlength="3" value="{$modvars.ZikulaAdminModule.itemsperpage|safetext}" />
            </div>
            <div class="z-formrow">
                <label for="admin_modulesperrow">{gt text="Modules per row in admin panel"}</label>
                <input id="admin_modulesperrow" name="modvars[modulesperrow]" type="text" size="3" maxlength="3" value="{$modvars.ZikulaAdminModule.modulesperrow|safetext}" />
            </div>
            <div class="z-formrow">
        ...
        <div class="z-buttons z-formbuttons">
            ...
            <a href="{modurl modname=ZikulaAdminModule type=admin func=view}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.png set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            <a class="z-btblue" href="{modurl modname=ZikulaAdminModule type=admin func=help fragment=modifyconfig}" title="{gt text="Help"}">{img modname=core src=agt_support.png set=icons/extrasmall __alt="Help" __title="Help"} {gt text="Help"}</a>
        </div>
    </div>
</form>
{adminfooter}