    ...
    <div>
        ...
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-9">
                ...
                <a class="btn btn-default" class="z-btblue" href="{modurl modname=ZikulaAdminModule type=admin func=help fragment=modifyconfig}" title="{gt text="Help"}">{img modname=core src=agt_support.png set=icons/extrasmall __alt="Help" __title="Help"} {gt text="Help"}</a>
            </div>
        </div>
    </div>
</form>
