    ...
    <div>
        ...
        <div class="form-group">
             <div class="col-lg-offset-3 col-lg-9">
                ...
                <a class="btn btn-default" class="z-btblue" href="{modurl modname=ZikulaAdminModule type=admin func=help fragment=modifyconfig}" title="{gt text="Help"}"><span title="{gt text="Help"}" alt="{gt text="Help"}" class="glyphicon glyphicon16 glyphicon-question-sign glyphicon-bluelight"></span> {gt text="Help"}</a>
            </div>
        </div>
    </div>
</form>
