...
<form class="authentication_select_method" style="margin-bottom: 5px;" id="{$idPrefix}-form_{$authentication_method.modname|lower}_{$authentication_method.method|lower}" method="post" action="{$form_action}" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <button style="text-align: left; padding-left: 5px;" type="submit" id="{$idPrefix}_submit_{$authentication_method.modname|lower}_{$authentication_method.method|lower}" class="btn btn-default btn-xs btn-block authentication_select_method_button" name="submit">
