...
<form id="{$formData->getFormId()}" class="z-form" action="{modurl modname='ZikulaUsersModule' type='admin' func='modifyRegistration'}" method="post">
    <div>
