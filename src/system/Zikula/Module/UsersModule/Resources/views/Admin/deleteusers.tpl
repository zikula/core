...
<form class="z-form" action="{modurl modname='UsersModule' type='admin' func='deleteUsers'}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <div class="z-formbuttons z-buttons">
            ...
            <a class="z-btred" href="{modurl modname='UsersModule' type='admin' func='view'}" title="{gt text='Cancel'}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
        </div>
    </div>
</form>
{adminfooter}
