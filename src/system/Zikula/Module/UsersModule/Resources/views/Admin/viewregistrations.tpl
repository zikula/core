    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <span class="icon-ok icon-green tooltips" title="{gt text='Approved'}"></span>
                {else}
                <span class="icon-remove icon-red tooltips" title="{gt text='Pending approval'}"></span>
                {/if}
            </td>
            <td class="text-center">
                {if $reginfo.isverified}
                <span class="icon-ok icon-green tooltips" title="{gt text='Verified'}"></span>
                ...
                <span class="icon-warning-sign icon-red tooltips" title="{gt text='E-mail verification not sent; must be resent'}"></span>
                {else}
                <span class="icon-remove icon-red tooltips" title="{gt text='E-mail verification not sent'}"></span>
                {/if}
                {else}
                <span class="icon-time icon-red tooltips"  title="{gt text='Pending verification of e-mail address'}"></span>
                {/if}
            </td>
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        <tr>
            <td class="col-md-6">
                <span title="{gt text='Approved'}" class="icon-ok icon-green"></span>
                {gt text='An administrator has approved the registration, or approval was not required when the registration was completed.'}
            </td>
            <td class="col-md-6">
                <span title="{gt text='Pending approval'}" class="icon-remove icon-red"></span>
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        <tr>
            <td class="col-md-6">
                <span title="{gt text='Verified'}" class="icon-ok icon-green"></span>
            ...
            <td class="col-md-6">
                <span title="{gt text='Pending verification of e-mail address'}" class="icon-time icon-orange"></span>
                {gt text='An e-mail has been sent to the registered e-mail address, but the user has not yet responded.'}
            </td>
        </tr>
        <tr>
            <td>
                <span title="{gt text='Verification e-mail message not yet sent'}" class="icon-remove icon-red"></span>
            ...
            <td>
                <span title="{gt text='E-mail verification not sent; must be resent'}" class="icon-warning-sign icon-red"></span>
