...
<p>{gt text='Hello! You requested to change your e-mail address for user account \'%1$s\' at %2$s from %3$s to %4$s.' tag1=$uname tag2=$sitename tag3=$email tag4=$newemail}
   {gt text='You must confirm this change before it will take effect.'}{if $modvars.ZikulaUsersModule.chgemail_expiredays > 0} {gt text='If you do not confirm this change within the next day, the request will be deleted from our system.' plural='If you do not confirm this change within the next %1$s days, the request will be deleted from our system.' tag1=modvars.ZikulaUsersModule.chgemail_expiredays count=$modvars.ZikulaUsersModule.chgemail_expiredays}{/if}</p>
