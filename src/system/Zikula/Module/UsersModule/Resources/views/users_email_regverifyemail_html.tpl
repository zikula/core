...
{modurl modname='ZikulaUsersModule' type='user' func='verifyRegistration' uname=$reginfo.uname verifycode=$verifycode|urlencode fqurl=true assign='verificationurl'}
