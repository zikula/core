{ajaxheader modname='ZikulaMailerModule' filename='mailer_admin_testconfig.js' noscriptaculous=true effects=true}
{adminheader}
...
{form cssClass='form-horizontal'}
    <div>
        ...
        <fieldset>
            ...
            <div id="mailer_body_div" class="form-group">
            ...
            <div id="mailer_textbody_div" class="form-group">
