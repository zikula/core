...
<form class="z-form" action="{modurl modname="ZikulaSettingsModule" type="admin" func="updatemultilingual"}" method="post">
    <div>
        ...
        <div class="z-buttons z-formbuttons">
            ...
            <a href="{modurl modname="ZikulaSettingsModule" type="admin" func="main"}" title="{gt text="Cancel"}">{img modname="core" src="button_cancel.png" set="icons/extrasmall" __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
        </div>
    </div>
</form>
{adminfooter}