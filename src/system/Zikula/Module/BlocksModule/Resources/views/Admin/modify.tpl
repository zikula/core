...
<form id="blockupdateform" class="form-horizontal" role="form" action="{route name='zikulablocksmodule_admin_update'}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
                ...
                <div id="block_placement_advanced" style="display: none">
                    ...
                    <div>
                        <ol id="placementfilterslist" class="z-itemlist">
                            ...
                            {foreach name='loop_filters' item='placementfilter' from=$filter}
                        ...
                        <li id="placementfilterslist_emptyitem" class="clearfix">
                            <span class="z-itemcell z-w25">
                                <select class="listinput" class="form-control" id="filters_X_module" name="filtersdummy[]">
                                    {foreach name='modlist' key='name' item='displayname' from=$mods}
        ...
        {if $blockoutput eq '' && $form_content eq true}
            <fieldset>
