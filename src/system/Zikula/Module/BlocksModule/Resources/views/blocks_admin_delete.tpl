    ...
    <div>
        ...
        <fieldset>
            ...
            <div class="col-lg-offset-3 col-lg-9">
                    ...
                    <a class="btn btn-default" class="z-btred" href="{modurl modname=Blocks type=admin func=view}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.png set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
                </div>
        </div>
        </div>
        </fieldset>
