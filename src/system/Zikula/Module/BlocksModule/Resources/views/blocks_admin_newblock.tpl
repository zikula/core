...
<form class="z-form" action="{modurl modname="Blocks" type="admin" func="create"}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                <div>
                    ...
                    <select id="blocks_position" name="block[positions][]" multiple="multiple" size="{$selectsize}>
        ...
        <div class="z-buttons z-formbuttons">
            ...
            <a href="{modurl modname='ZikulaBlocksModule' type='admin' func='view'}" title="{gt text="Cancel"}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text="Cancel"}</a>
        </div>
    </div>
</form>
{adminfooter}
