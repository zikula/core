...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="actions">
                <a class="icon-eye-open tooltips" href="{modurl modname=$module type='user' func='display' bid=$block.bid|safetext showinactive=true}" title="{$lbl_preview_block}"></a>
                {if $access_edit}
                <a class="icon-pencil tooltips" href="{modurl modname=$module type='admin' func='modify' bid=$block.bid|safetext}" title="{$lbl_edit_block}"></a>
                {/if}
                {if $access_delete}
                <a class="icon-trash tooltips" href="{modurl modname=$module type='admin' func='delete' bid=$block.bid|safetext}" title="{$lbl_delete_block}"></a>
                {/if}
            </td>
        </tr>
        {foreachelse}
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="actions">
                {if $access_edit}
                <a class="icon-pencil tooltips" href="{modurl modname=$module type='admin' func='modifyposition' pid=$position.pid|safetext}" title="{$lbl_edit_blockposition}"></a>
                {/if}
                {if $access_delete}
                <a class="icon-trash tooltips" href="{modurl modname=$module type='admin' func='deleteposition' pid=$position.pid|safetext}" title="{$lbl_delete_blockposition}"></a>
                {/if}
            </td>
        </tr>
        {foreachelse}
