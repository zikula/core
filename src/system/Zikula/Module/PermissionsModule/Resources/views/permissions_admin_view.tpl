    ...
    <fieldset>
        ...
        <span class="nowrap">
            <select id="filter-group" name="filter-group">
                ...
                <option value="{$groupid}" {if $groupid == $filterGroup}selected{/if}>{$groupname}</option>
                {/foreach}
            </select>
            <select id="filter-component" name="filter-component">
                {foreach item=component from=$components key=compkey}
                <option value="{$compkey}" {if $compkey == $filterComponent}selected{/if}>{$component}</option>
                {/foreach}
            </select>
        </span>
        <span class="nowrap"">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-9">
                <button class="btn btn-default" id="test-permission" title="{gt text="Check permission"}">
                    {gt text="Check permission"}
                </button>
                <button class="btn btn-danger" type="reset" title="{gt text="Reset"}">
                    {gt text="Reset"}
                </button>
            </div>
        </div>
