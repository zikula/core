...
{pageaddvar name="javascript" value="vendor/abeautifulsite/jquery-minicolors/jquery.minicolors.min.js"}
{pageaddvar name="stylesheet" value="vendor/abeautifulsite/jquery-minicolors/jquery.minicolors.css"}
