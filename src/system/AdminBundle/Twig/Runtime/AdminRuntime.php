...
namespace Zikula\AdminBundle\Twig\Runtime;
...
class AdminRuntime implements RuntimeExtensionInterface
{
    ...
    {
        $ref = new ControllerReference('Zikula\AdminBundle\Controller\AdminInterfaceController::breadcrumbs');
    ...
    {
        $ref = new ControllerReference('Zikula\AdminBundle\Controller\AdminInterfaceController::footer');
    ...
    {
        $ref = new ControllerReference('Zikula\AdminBundle\Controller\AdminInterfaceController::header');
    ...
    public function adminMenu(string $mode = 'categories', string $template = 'tabs'): string
    {
        ...
        $ref = new ControllerReference('Zikula\AdminBundle\Controller\AdminInterfaceController::menu', [
            'mode' => $mode,
            'template' => $template
        ]);
    ...
    {
        $ref = new ControllerReference('Zikula\AdminBundle\Controller\AdminInterfaceController::updatecheck');
