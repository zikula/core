...
class Mailer_Admin extends Zikula_Controller
{
    ...
    public function modifyconfig()
    {
        ...
        $this->renderer->assign('mailertypes', array(1 => DataUtil::formatForDisplay($this->__("PHP 'mail()' function")),
        ...
        $this->renderer->assign(ModUtil::getVar('Mailer'));

        return $this->renderer->fetch('mailer_admin_modifyconfig.htm');
    }
    ...
    public function testconfig()
    {
        ...
        return $this->renderer->fetch('mailer_admin_testconfig.htm');
    }
