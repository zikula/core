...
<div class="z-admincontainer">
    <div class="z-adminpageicon">{img modname=core src=mail.png set=icons/large __alt="Test current settings"}</div>
    ...
    <form class="z-form" action="{modurl modname="Mailer" type="admin" func="sendmessage"}" method="post" enctype="application/x-www-form-urlencoded">
        <div>
            ...
            <div class="z-buttons z-formbuttons">
                ...
                <a href="{modurl modname=Mailer type=admin}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.png set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            </div>
        </div>
    </form>
</div>
