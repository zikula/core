...
<div class="z-admincontainer">
    <div class="z-adminpageicon">{img modname=core src=inbox.gif set=icons/large __alt="Test current settings"}</div>
    ...
    <form class="z-form" action="{modurl modname="Mailer" type="admin" func="sendmessage"}" method="post" enctype="application/x-www-form-urlencoded">
        <div>
            ...
            <div class="z-buttons z-formbuttons">
                {button src=button_ok.gif set=icons/extrasmall __alt="Test settings now" __title="Test settings now" __text="Test settings now"}
                <a href="{modurl modname=Mailer type=admin}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.gif set=icons/extrasmall __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
            </div>
        </div>
    </form>
</div>
