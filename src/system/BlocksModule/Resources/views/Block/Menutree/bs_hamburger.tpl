    ...
    <div class="container">
        ...
        <div class="menutree collapse navbar-collapse" id="menutree-{$blockinfo.bid}">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a class="fa fa-plus" href="{route name='zikulablocksmodule_block_edit' blockEntity=$blockinfo.bid addurl=1}#menutree_tabs" title="{gt text='Add the current URL as new link in this block'}"></a></li>
                <li><a class="fa fa-pencil" href="{route name='zikulablocksmodule_block_edit' blockEntity=$blockinfo.bid fromblock=1}" title="{gt text='Edit this block'}"></a></li>
            </ul>
            {/if}
        </div>
    </div>
