                ...
                <div class="form-group">
                    ...
                    <fieldset id="menutree_linkclasses_group" style="margin: 0 1em">
                        ...
                        <ul id="menutree_linkclasses_list" class="z-itemlist">
                            ...
                            {foreach key='id' item='class' from=$menutree_linkclasses}
        ...
        <ul class="navbar navbar-default navbar-modulelinks">
            ...
            {if $multilingual}
                <li>
                    ...
                    {foreach name='langLoop' key='langCode' item='langName' from=$languages}
                        <a href="#" lang="{$langCode}" class="menutree_langcontrols{if $langCode eq $defaultlanguage} activelang{/if}">{$langName}</a> {if !$smarty.foreach.langLoop.last} | {/if}
                    {/foreach}
                </li>
            {/if}
        </ul>
