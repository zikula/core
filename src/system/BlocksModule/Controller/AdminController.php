...
class AdminController extends \Zikula_AbstractController
{
    ...
    public function mainAction()
    {
        ...
        $this->redirect(ModUtil::url('BlocksModule', 'admin', 'view'));
    }
    ...
    public function updateAction()
    {
        ...
        if (!$blockinfo) {
            $this->redirect(ModUtil::url('BlocksModule', 'admin', 'modify', array('bid' => $bid)));
        }
        ...
        if (!empty($returntoblock)) {
            ...
            $this->redirect(ModUtil::url('BlocksModule', 'admin', 'modify',
    ...
    public function createAction()
    {
        ...
        if ($block['blockid'] == '') {
            $block['blockid'] = 'error';
            $url = ModUtil::url('BlocksModule', 'admin', 'newblock', array('block' => $block));
    ...
    public function createpositionAction()
    {
        ...
        if (!isset($position['name']) || !preg_match('/^[a-z0-9_-]*$/i', $position['name']) || !isset($position['description'])) {
            return LogUtil::registerArgsError(ModUtil::url('BlocksModule', 'admin', 'view'));
        }
        ...
        if ($pid) {
            ...
            $this->redirect(ModUtil::url('BlocksModule', 'admin', 'modifyposition', array('pid' => $pid), null, 'blockpositionform'));
        }
    ...
    public function updatepositionAction()
    {
        ...
        $this->redirect(ModUtil::url('BlocksModule', 'admin', 'modifyposition', array('pid' => $position['pid'])));
    }
