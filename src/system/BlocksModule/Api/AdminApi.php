...
use System;
use SecurityUtil;
use BlocksModule\Entity\BlockPlacementEntity;
use ModUtil;
use BlocksModule\Entity\BlockEntity;
use BlocksModule\Entity\BlockPositionEntity;
...
class AdminApi extends \Zikula_AbstractApi
{
    ...
    public function update($args)
    {
        ...
        $items = $this->entityManager->getRepository($this->name . '\Entity\BlockPlacementEntity')
    ...
    public function delete($args)
    {
        ...
        $entity = $this->name . '\Entity\BlockPlacementEntity';
    ...
    public function deleteposition($args)
    {
        ...
        // delete position
        $entity = $this->name . '\Entity\BlockPositionEntity';
        $dql = "DELETE FROM $entity p WHERE p.pid = {$position['pid']}";
        $query = $this->entityManager->createQuery($dql);
        $query->getResult();
    ...
    public function getlinks()
    {
        ...
        foreach ($blockspositions as $blocksposition) {
            ...
            $submenulinks[] = array('url' => ModUtil::url('BlocksModule', 'admin', 'view', array('filter' => $filter)),
