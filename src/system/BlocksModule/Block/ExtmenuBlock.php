...
class ExtmenuBlock extends \Zikula_Controller_AbstractBlock
{
    ...
    public function display($blockinfo)
    {
        ...
        PageUtil::addVar('stylesheet', ThemeUtil::getModuleStylesheet('BlocksModule', $vars['stylesheet']));
            ...
            if (count($menuitems) > 0) {
                ...
                if (SecurityUtil::checkPermission('ExtendedMenublock::', $blockinfo['bid'] . '::', ACCESS_ADMIN)) {
                    $menuitems[] = array('name'   => $this->__('--Installed modules--'),
                                         'url'    => ModUtil::url('BlocksModule', 'admin', 'modify', array('bid' => $blockinfo['bid'])),
                                         'title'  => '',
                                         'level'  => 0,
                                         'parentid' => null,
                                         'image'  => '');
