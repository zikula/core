...
namespace Zikula\SecurityCenterBundle\Controller;
...
class ConfigController extends AbstractController
{
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('save')->isClicked()) {
                ...
                if (true === $causeLogout) {
                    ...
                    $returnPage = urlencode($router->generate('zikulasecuritycenterbundle_config_config'));

                    return $this->redirectToRoute('zikulausersbundle_access_login', ['returnUrl' => $returnPage]);
                }
            } elseif ($form->get('cancel')->isClicked()) {
                $this->addFlash('status', 'Operation cancelled.');
            }

            return $this->redirectToRoute('zikulasecuritycenterbundle_config_config');
        }
    ...
    public function purifierconfig(
        ...
        if (Request::METHOD_POST === $request->getMethod()) {
            ...
            return $this->redirectToRoute('zikulasecuritycenterbundle_config_purifierconfig');
        }
    ...
    public function allowedhtml(
        ...
        if (Request::METHOD_POST === $request->getMethod()) {
            ...
            return $this->redirectToRoute('zikulasecuritycenterbundle_config_allowedhtml');
        }

        return [
            'htmlEntities' => $variableApi->getSystemVar('htmlentities'),
            'htmlPurifier' => 1 === $variableApi->getSystemVar('outputfilter'),
            'configUrl' => $router->generate('zikulasecuritycenterbundle_config_config'),
            'htmlTags' => $htmlTags,
