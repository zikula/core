...
class AjaxController extends \Zikula_Controller_AbstractAjax
{
    ...
    public function updatepermissionAction()
    {
        ...
        $permission = $this->entityManager->find('PermissionsModule\Entity\PermissionEntity', $pid);
    ...
    public function deletepermissionAction()
    {
        ...
        $perm = $this->entityManager->find('PermissionsModule\Entity\PermissionEntity', $pid);
