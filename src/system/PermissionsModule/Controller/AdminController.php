...
class AdminController extends \Zikula_AbstractController
{
    ...
    public function viewAction()
    {
        ...
        $dql = "SELECT p FROM PermissionsModule\Entity\PermissionEntity p $where ORDER BY p.sequence ASC";
        ...
        $allperms = $this->entityManager->getRepository('PermissionsModule\Entity\PermissionEntity')->findBy(array(), array('sequence' => 'ASC'));
    ...
    public function listeditAction()
    {
        ...
        $ids = $this->getGroupsInfo();        $this->view->assign('idvalues', $ids);
        ...
        $accesslevels = SecurityUtil::accesslevelnames();        $permissions = array();
    ...
    public function updateconfigAction()
    {
        ...
        if ($adminid <> 0) {
            $perm = $this->entityManager->find('PermissionsModule\Entity\PermissionEntity', $adminid);
            if (!$perm) {
                $adminid = 0;
                $error = true;
            }
