...
class Groups_Admin extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        return $this->renderer->fetch('groups_admin_main.tpl');
    }
    ...
    public function view()
    {
        ...
        $this->renderer->assign('pager', array('numitems'     => ModUtil::apiFunc('Groups', 'admin', 'countitems'),
                                               'itemsperpage' => $itemsperpage));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('groups_admin_view.tpl');
    }
    ...
    public function newgroup()
    {
        ...
        $this->renderer->assign('grouptype',  $grouptype)
                       ->assign('groupstate', $groupstate);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('groups_admin_new.tpl');
    }
    ...
    public function modify($args)
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('groups_admin_modify.tpl');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->renderer->fetch('groups_admin_delete.tpl');
        }
    ...
    public function groupmembership($args)
    {
        ...
        $this->renderer->assign('groupmembers', $groupmembers);
        ...
        $this->renderer->assign('uids', $allusers);
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('groups_admin_groupmembership.tpl');
    }
    ...
    public function userpending()
    {
        ...
        return $this->renderer->fetch('groups_admin_userpending.tpl');
    }
    ...
    public function modifyconfig()
    {
        ...
        $this->renderer->assign('groups', $groupslist);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('groups_admin_modifyconfig.tpl');
    }
