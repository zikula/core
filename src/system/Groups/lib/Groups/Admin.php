...
class Groups_Admin extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        return $renderer->fetch('groups_admin_main.htm');
    }
    ...
    public function view()
    {
        ...
        $renderer->assign('grouptypes',     $typelabel);
        $renderer->assign('states',         $statelabel);
        $renderer->assign('useritems',      $users);
        $renderer->assign('defaultgroup',   $defaultgroup);

        // Assign the values for the smarty plugin to produce a pager
        $renderer->assign('pager', array('numitems'     => ModUtil::apiFunc('Groups', 'admin', 'countitems'),
                'itemsperpage' => $itemsperpage));

        // Return the output that has been generated by this function
        return $renderer->fetch('groups_admin_view.htm');
    }
    ...
    public function newgroup()
    {
        ...
        // Setting various defines
        $grouptype = array('-1' => $this->__('Core'),
                '1'  => $this->__('Public'),
                '2'  => $this->__('Private'));

        $groupstate = array('0' => $this->__('Closed'),
                '1' => $this->__('Open'));

        $renderer->assign('grouptype',  $grouptype);
        $renderer->assign('groupstate', $groupstate);

        // Return the output that has been generated by this function
        return $renderer->fetch('groups_admin_new.htm');
    }
    ...
    public function modify($args)
    {
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('groups_admin_modify.htm');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('groups_admin_delete.htm');
        }
    ...
    public function groupmembership($args)
    {
        ...
        $renderer->assign('groupmembers', $groupmembers);
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('groups_admin_groupmembership.htm');
    }
    ...
    public function userpending()
    {
        ...
        if (ModUtil::available('Messages')) {
            $sendoptions = array(0 => $this->__('None'),
        ...
        $renderer->assign('sendoptions', $sendoptions);
        $renderer->assign('application', $appinfo['application']);

        return $renderer->fetch('groups_admin_userpending.htm');
    }
    ...
    public function modifyconfig()
    {
        ...
        $renderer->assign('defaultgroupid', $modvars['defaultgroup']);
        ...
        $renderer->assign('groups', $groupslist);

        // Return the output that has been generated by this function
        return $renderer->fetch('groups_admin_modifyconfig.htm');
    }
