            ...
            <li id="group_{$group.gid}" class="{cycle values='z-odd,z-even'} z-clearfix">
                <div id="groupcontent_{$group.gid}">
                    ...
                    <span id="groupaction_{$group.gid}" class="z-itemcell z-w10">
                        <button class="z-imagebutton z-hide tooltips" id="modifyajax_{$group.gid}" title="{gt text="Edit group: `$group.name`"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit" __alt="Edit"}</button>
                        <a id="modify_{$group.gid}"  href="{$group.editurl|safetext}" title="{gt text="Edit"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit group: `$group.name`" __alt="Edit" class='tooltips'}</a>
                        <a id="delete_{$group.gid}"     href="{$group.deleteurl|safetext}" title="{gt text="Delete"}">{img src=editdelete.gif modname=core set=icons/extrasmall __title="Delete group: `$group.name`" __alt="Delete" class='tooltips'}</a>
                    ...
                    <span id="editgroupaction_{$group.gid}" class="z-itemcell z-w10 z-hide">
                        ...
                        <button class="z-imagebutton tooltips" id="groupeditdelete_{$group.gid}" title="{gt text="Delete group: `$group.name`"}">{img src=editdelete.gif modname=core set=icons/extrasmall __alt="Delete" __title="Delete"}</button>
            ...
            <li id="group_1" class="z-hide z-clearfix">
                <div id="groupcontent_1" class="groupcontent">
                    ...
                    <span id="groupaction_1" class="z-itemcell z-w12 z-hide">
                        <button class="z-imagebutton" id="modifyajax_1" title="{gt text="Edit"}">{img src=edit.gif modname=core set=icons/extrasmall __title="Edit" __alt="Edit"}</button>
                    </span>
                    <span id="editgroupaction_1" class="z-itemcell z-w12">
                        ...
                        <button class="z-imagebutton" id="groupeditdelete_1" title="{gt text="Delete"}">{img src=editdelete.gif modname=core set=icons/extrasmall __alt="Delete" __title="Delete:"}</button>
