...
class AdminCategoryHelper
{
    ...
    public function getBundleAssignments(AdminCategoryEntity $category): array
    {
        return match ($category->getSlug()) {
            'system' => ['ZikulaExtensionsModule', 'ZikulaRoutesModule', 'ZikulaSettingsModule'],
            'layout' => ['ZikulaAdminModule', 'ZikulaDefaultTheme', 'ZikulaMenuModule', 'ZikulaThemeModule'],
            'users' => ['ZikulaGroupsModule', 'ZikulaLegalModule', 'ZikulaPermissionsModule', 'ZikulaProfileModule', 'ZikulaUsersModule', 'ZikulaZAuthModule'],
            'content' => ['ZikulaStaticContentModule'],
            'uncategorized' => [],
            'security' => ['ZikulaSecurityCenterModule'],
        };
    }
}
