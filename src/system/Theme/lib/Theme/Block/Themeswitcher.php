...
class Theme_Block_Themeswitcher extends AbstractBlock
{
    ...
    public function display($blockinfo)
    {
        ...
        $render = Renderer::getInstance('Theme');
        $render->assign($vars);
        $render->assign('currentthemepic', $currentthemepic);
        $render->assign('currenttheme', $currenttheme);
        $render->assign('themes', $previewthemes);
        $blockinfo['content'] = $render->fetch('theme_block_themeswitcher.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        return $render->fetch('theme_block_themeswitcher_modify.htm');
    }
    ...
    function update($blockinfo)
    {
        ...
        $render = Renderer::getInstance('Theme');
        $render->clear_cache('theme_block_themeswitcher.htm');
