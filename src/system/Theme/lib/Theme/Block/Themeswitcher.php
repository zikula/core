...
class Theme_Block_Themeswitcher extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $this->renderer->fetch('theme_block_themeswitcher.tpl');
    ...
    public function modify($blockinfo)
    {
        ...
        return $this->renderer->fetch('theme_block_themeswitcher_modify.tpl');
    }
    ...
    function update($blockinfo)
    {
        ...
        $this->renderer->clear_cache('theme_block_themeswitcher.tpl');
