...
class Theme_Admin extends Zikula_Controller
{
    ...
    public function newtheme()
    {
        ...
        return $renderer->fetch('theme_admin_newtheme.htm');
    }
    ...
    public function view($args = array())
    {
        ...
        $renderer->assign('themes', $themes);

        // assign default theme
        $renderer->assign('currenttheme', System::getVar('Default_Theme'));

        // assign the values for the smarty plugin to produce a pager
        $renderer->assign('pager', array('numitems'     => sizeof($allthemes),
                'itemsperpage' => $itemsperpage));

        // Return the output that has been generated to the template
        return $renderer->fetch('theme_admin_view.htm');
    }
    ...
    public function modify($args)
    {
        ...
        $renderer->assign('themename', $themename);

        // assign the theme info
        $renderer->assign('themeinfo', $themeinfo);

        // Return the output that has been generated to the template
        return $renderer->fetch('theme_admin_modify.htm');
    }
    ...
    public function variables($args)
    {
        ...
        $renderer->assign('variables', ModUtil::apiFunc('Theme', 'user', 'getvariables', array('theme' => $themename, 'formatting' => true)));
        ...
        return $renderer->fetch('theme_admin_variables.htm');
    }
    ...
    public function palettes($args)
    {
        ...
        // assign the palettes
        $renderer->assign('palettes', ModUtil::apiFunc('Theme', 'user', 'getpalettes', array('theme' => $themename)));

        // Return the output that has been generated by this function
        return $renderer->fetch('theme_admin_palettes.htm');
    }
    ...
    public function pageconfigurations($args)
    {
        ...
        $renderer->assign('pageconfigurations', $pageconfigurations);
        ...
        $renderer->assign('pageconfigs', $pageconfigfiles);

        // Return the output that has been generated by this function
        return $renderer->fetch('theme_admin_pageconfigurations.htm');
    }
    ...
    public function modifypageconfigtemplates($args)
    {
        ...
        $renderer->assign('filename', $filename);
        $renderer->assign('themename', $themename);
        ...
        // get all templates
        $renderer->assign('moduletemplates', ModUtil::apiFunc('Theme', 'user', 'gettemplates', array('theme' => $themename)));
        $renderer->assign('blocktemplates', ModUtil::apiFunc('Theme', 'user', 'gettemplates', array('theme' => $themename, 'type' => 'blocks')));

        // get all palettes
        $renderer->assign('palettes', ModUtil::apiFunc('Theme', 'user', 'getpalettenames', array('theme' => $themename)));
        ...
        $renderer->assign('blockpositions', $positions);

        // call the block API to get a list of all available blocks
        $renderer->assign('allblocks', $allblocks = BlockUtil::loadAll());
        ...
        $renderer->assign('blocks', $blocks = ModUtil::apiFunc('Blocks', 'user', 'getall'));
        foreach ($blocks as $block) {
            // check the page configuration
        ...
        $renderer->assign('pageconfiguration', $pageconfiguration);

        // Return the output that has been generated by this function
        return $renderer->fetch('theme_admin_modifypageconfigtemplates.htm');
    }
    ...
    public function modifypageconfigurationassignment($args)
    {
        ...
        $renderer->assign('filename', $pageconfigurations[$pcname]['file']);
        ...
        $renderer->assign($pageconfigassignment);

        // Return the output that has been generated by this function
        return $renderer->fetch('theme_admin_modifypageconfigurationassignment.htm');
    }
    ...
    public function deletepageconfigurationassignment($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('theme_admin_deletepageconfigurationassignment.htm');
        }
    ...
    public function credits($args)
    {
        ...
        // assign the theme info
        $renderer->assign('themeinfo', ThemeUtil::getInfo(ThemeUtil::getIDFromName($themename)));

        // Render the output
        return $renderer->fetch('theme_admin_credits.htm');
    }
    ...
    public function setasdefault($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            $renderer->assign('theme_change', System::getVar('theme_change'));

            // Return the output that has been generated by this function
            return $renderer->fetch('theme_admin_setasdefault.htm');
        }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('theme_admin_delete.htm');
        }
    ...
    public function modifyconfig()
    {
        ...
        $renderer->assign(ModUtil::getVar('Theme'));

        // assign an authid for the clear cache/compile links
        $renderer->assign('authid', SecurityUtil::generateAuthKey('Theme'));
        ...
        $renderer->assign('mods', $mods);

        // assign an extracted list of non-cached mods
        $renderer->assign('modulesnocache', array_flip(explode(',', ModUtil::getVar('Theme', 'modulesnocache'))));

        // check for a .htaccess file
        if (file_exists('.htaccess')){
            $renderer->assign('htaccess', 1);
        } else {
            $renderer->assign('htaccess', 0);
        }

        // register the renderer object allow access to various smarty values
        $renderer->register_object('render', $renderer);

        // Return the output that has been generated by this function
        return $renderer->fetch('theme_admin_modifyconfig.htm');
    }
