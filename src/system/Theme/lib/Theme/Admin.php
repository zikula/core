...
class Theme_Admin extends Zikula_Controller
{
    ...
    public function newtheme()
    {
        ...
        return $pnRender->fetch('theme_admin_newtheme.htm');
    }
    ...
    public function view($args = array())
    {
        ...
        $pnRender->assign('currenttheme', System::getVar('Default_Theme'));
    ...
    public function variables($args)
    {
        ...
        $pnRender->assign('variables', ModUtil::apiFunc('Theme', 'user', 'getvariables', array('theme' => $themename, 'formatting' => true)));
    ...
    public function palettes($args)
    {
        ...
        // assign the palettes
        $pnRender->assign('palettes', ModUtil::apiFunc('Theme', 'user', 'getpalettes', array('theme' => $themename)));
    ...
    public function modifypageconfigtemplates($args)
    {
        ...
        // get all templates
        $pnRender->assign('moduletemplates', ModUtil::apiFunc('Theme', 'user', 'gettemplates', array('theme' => $themename)));
        $pnRender->assign('blocktemplates', ModUtil::apiFunc('Theme', 'user', 'gettemplates', array('theme' => $themename, 'type' => 'blocks')));

        // get all palettes
        $pnRender->assign('palettes', ModUtil::apiFunc('Theme', 'user', 'getpalettenames', array('theme' => $themename)));
        ...
        $pnRender->assign('blocks', $blocks = ModUtil::apiFunc('Blocks', 'user', 'getall'));
        foreach ($blocks as $block) {
            // check the page configuration
