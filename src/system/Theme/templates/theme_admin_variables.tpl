        ...
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname=Theme type=admin func=pageconfigurations themename=$themename}" title="{gt text="Cancel"}">{img modname=core src=button_cancel.gif set=icons/small __alt="Cancel" __title="Cancel"} {gt text="Cancel"}</a>
                </div>
            </fieldset>
        </div>
    </form>
