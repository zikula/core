...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('system/Theme/pnincludes/picker.html', null, "help=no,status=no,scrollbars=no,resizable=yes" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
