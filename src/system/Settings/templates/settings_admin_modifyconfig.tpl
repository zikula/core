        ...
        <div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input id="settings_sitename" type="text" name="settings[sitename]" value="{$settings.sitename|safetext}" size="50" maxlength="100" />
                </div>
                <div class="z-formrow">
                    <label for="settings_slogan">{gt text="Description line"}</label>
                    <input id="settings_slogan" type="text" name="settings[slogan]" value="{$settings.slogan|safetext}" size="50" maxlength="100" />
                </div>
                <div class="z-formrow">
                    <label for="settings_adminmail">{gt text="Admin's e-mail address"}</label>
                    <input id="settings_adminmail" type="text" name="settings[adminmail]" value="{$settings.adminmail|safetext}" size="30" maxlength="100" />
                </div>
                <div class="z-formrow">
                    <label for="settings_siteoff">{gt text="Disable site"}</label>
                    <div id="settings_siteoff">
                        <input id="settings_siteoff_yes" type="radio" name="settings[siteoff]" value="1" {if $settings.siteoff eq 1}checked="checked"{/if} />
                        <label for="settings_siteoff_yes">{gt text="Yes"}</label>
                        <input id="settings_siteoff_no" type="radio" name="settings[siteoff]" value="0" {if $settings.siteoff eq 0}checked="checked"{/if} />
                ...
                <div id="settings_siteoff_container">
                    <div class="z-formrow">
                        ...
                        <textarea id="settings_siteoffreason" class="z_texpand" name="settings[siteoffreason]" cols="50" rows="5">{$settings.siteoffreason|safetext}</textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div id="settings_keywords_container">
                    <div class="z-formrow">
                        ...
                        <textarea id="settings_metakeywords" class="z_texpand" name="settings[metakeywords]" cols="60" rows="5">{$settings.metakeywords|safetext}</textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <select id="settings_startpage" name="settings[startpage]">
                        ...
                        {html_select_modules selected=$settings.startpage type=user}
                    </select>
                    <em class="z-formnote">{gt text="('index.php' points to this)"}</em>
                </div>
                <div class="z-formrow">
                    <label for="settings_starttype">{gt text="Start function type"}</label>
                    <input id="settings_starttype" type="text" name="settings[starttype]" value="{$settings.starttype|safetext}" size="10" maxlength="10" />
                </div>
                <div class="z-formrow">
                    <label for="settings_startfunc">{gt text="Start function"}</label>
                    <input id="settings_startfunc" type="text" name="settings[startfunc]" value="{$settings.startfunc|safetext}" size="20" maxlength="40" />
                </div>
                <div class="z-formrow">
                    <label for="settings_startargs">{gt text="Start function arguments"}</label>
                    <input id="settings_startargs" type="text" name="settings[startargs]" value="{$settings.startargs|safetext}" size="20" maxlength="60" />
                    <em class="z-formnote">{gt text="(Comma-separated)"}</em>
                </div>
                <div class="z-formrow">
                    <label for="settings_entrypoint">{gt text="Site entry point"}</label>
                    <input id="settings_entrypoint" type="text" name="settings[entrypoint]" value="{$settings.entrypoint|safetext}" size="20" maxlength="60" />
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <div id="settings_usecompression">
                        <input id="UseCompression1" type="radio" name="settings[UseCompression]" value="1" {if $settings.UseCompression eq 1}checked="checked"{/if} />
                        <label for="UseCompression1">{gt text="Yes"}</label>
                        <input id="UseCompression0" type="radio" name="settings[UseCompression]" value="0" {if $settings.UseCompression eq 0}checked="checked"{/if} />
                ...
                <div class="z-formrow">
                    ...
                    <select id="settings_profilemodule" name="settings[profilemodule]">
                        ...
                        {html_select_modules selected=$settings.profilemodule type="profile"}
                    </select>
                </div>
                <div class="z-formrow">
                    ...
                    <select id="settings_messagemodule" name="settings[messagemodule]">
                        ...
                        {html_select_modules selected=$settings.messagemodule type="message"}
                    </select>
                </div>
                <div class="z-formrow">
                    <label for="settings_ajaxtimeout">{gt text="Time-out for Ajax connections"}</label>
                    <input id="settings_ajaxtimeout" name="settings[ajaxtimeout]" value="{$settings.ajaxtimeout}" />
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input id="settings_permasearch" name="settings[permasearch]" value="{$settings.permasearch}" size="60" /><br />
                ...
                <div class="z-formrow">
                    ...
                    <input id="settings_permareplace" name="settings[permareplace]" value="{$settings.permareplace}" size="60" /><br />
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <div id="settings_shorturls">
                        <input id="settings_shorturls_yes" type="radio" name="settings[shorturls]" value="1" {if $settings.shorturls eq 1}checked="checked"{/if} />
                        <label for="settings_shorturls_yes">{gt text="Yes"}</label>
                        <input id="settings_shorturls_no" type="radio" name="settings[shorturls]" value="0" {if $settings.shorturls eq 0}checked="checked"{/if} />
                ...
                <div id="settings_shorturls_container">
                    ...
                    <div class="z-formrow">
                        ...
                        <div id="settings_shorturlstype">
                            {if $settings.shorturlstype eq 0}
                    ...
                    <div id="settings_shorturlsstripentrypoint_container" class="z-formrow">
                        ...
                        <div id="settings_shorturlsstripentrypoint">
                            <input id="shorturlsstripentrypoint1" type="radio" name="settings[shorturlsstripentrypoint]" value="1" {if $settings.shorturlsstripentrypoint eq 1}checked="checked"{/if} />
                            <label for="shorturlsstripentrypoint1">{gt text="Yes"}</label>
                            <input id="shorturlsstripentrypoint0" type="radio" name="settings[shorturlsstripentrypoint]" value="0" {if $settings.shorturlsstripentrypoint eq 0}checked="checked"{/if} />
                    ...
                    <div id="settings_shorturlsseparator_container" class="z-formrow">
                        ...
                        <input id="settings_shorturlsseparator" size="1" maxlength="1" name="settings[shorturlsseparator]" value="{$settings.shorturlsseparator}" />
                    </div>
                    <div id="settings_shorturlsext_container" class="z-formrow">
                        ...
                        <input id="settings_shorturlsext" name="settings[shorturlsext]" value="{$settings.shorturlsext}" />
                    </div>
                    <div id="settings_shorturls_defaultmodule_container" class="z-formrow">
                        ...
                        <select id="settings_shorturls_defaultmodule" name="settings[shorturlsdefaultmodule]">
                            ...
                            {html_select_modules selected=$settings.shorturlsdefaultmodule type=user}
                        </select>
                    </div>
            ...
            {modcallhooks hookobject=module hookaction=modifyconfig module=Settings}
