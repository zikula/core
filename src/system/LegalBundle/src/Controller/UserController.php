...
class UserController extends AbstractController
{
     ...
     */
    #[Route('/legalnotice', name: 'zikula_legal_user_legalnotice', methods: ['GET'])]
     ...
     * @throws AccessDeniedException Thrown if the user does not have the appropriate access level for the function
     */
    #[Route('/privacypolicy', name: 'zikula_legal_user_privacypolicy', methods: ['GET'])]
     ...
     * @throws AccessDeniedException Thrown if the user does not have the appropriate access level for the function
     */
    #[Route('/termsofuse', name: 'zikula_legal_user_termsofuse', methods: ['GET'])]
     ...
     * @throws AccessDeniedException Thrown if the user does not have the appropriate access level for the function
     */
    #[Route('/accessibilitystatement', name: 'zikula_legal_user_accessibilitystatement', methods: ['GET'])]
     ...
     * @throws AccessDeniedException Thrown if the user does not have the appropriate access level for the function
     */
    #[Route('/tradeconditions', name: 'zikula_legal_user_tradeconditions', methods: ['GET'])]
     ...
     * @throws AccessDeniedException Thrown if the user does not have the appropriate access level for the function
     */
    #[Route('/cancellationrightpolicy', name: 'zikula_legal_user_cancellationrightpolicy', methods: ['GET'])]
    ...
    #[Route('/acceptpolicies', name: 'zikula_legal_user_acceptpolicies')]
