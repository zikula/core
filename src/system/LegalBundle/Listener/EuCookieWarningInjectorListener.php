...
namespace Zikula\LegalBundle\Listener;
...
use Zikula\ThemeBundle\Api\PageAssetApi;
...
class EuCookieWarningInjectorListener implements EventSubscriberInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        $containsProhibitedRoute = in_array($routeInfo['_route'], ['_wdt', 'bazinga_jstranslation_js', 'fos_js_routing_js', 'zikulasearchbundle_search_opensearch']);
