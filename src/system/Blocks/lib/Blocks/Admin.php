...
class Blocks_Admin extends Zikula_Controller
{
    ...
    public function view()
    {
        ...
        $this->renderer->assign('blocks', $blocksitems);
        ...
        ksort($items);
        $this->renderer->assign('positions', $items);
        
        $this->renderer->assign('filter', $filter);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_view.htm');
    }
    ...
    public function modify()
    {
        ...
        if (!empty($modinfo['name'])) {
            $this->renderer->assign('modtitle', "$modinfo[name]/$blockinfo[bkey]");
        }

        // Add hidden block id to form
        $this->renderer->assign('bid', $bid);
        ...
        // assign the block
        $this->renderer->assign($blockinfo);

        // assign the list of modules
        $this->renderer->assign('mods', ModUtil::getAllMods());
        ...
        $this->renderer->assign('block_positions', $block_positions);
        ...
        // Block output
        $this->renderer->assign('blockoutput', $blockoutput);
        ...
        $this->renderer->assign($GLOBALS['blocks_modules'][$blockinfo['mid']][$blockinfo['bkey']]);
        ...
        $this->renderer->assign('blockrefreshtimes' , $refreshtimes);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_modify.htm');
    }
    ...
    public function newblock()
    {
        ...
        $this->renderer->assign('blockids', $blockinfo);
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_newblock.htm');
    }
    ...
    public function delete()
    {
        ...
        if (empty($confirmation)) {
            ...
            if (!empty($modinfo['name'])) {
                $this->renderer->assign('blockname', "$modinfo[name]/$blockinfo[bkey]");
            } else {
                $this->renderer->assign('blockname', "Core/$blockinfo[bkey]");
            }
            ...
            // Return the output that has been generated by this function
            return $this->renderer->fetch('blocks_admin_delete.htm');
        }
    ...
    public function newposition()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_newposition.htm');
    }
    ...
    public function modifyposition()
    {
        ...
        $this->renderer->assign('assignedblocks', $blocks)
                       ->assign('unassignedblocks', $allblocks);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_modifyposition.htm');
    }
    ...
    public function deleteposition($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            return $this->renderer->fetch('blocks_admin_deleteposition.htm');
        }
    ...
    public function modifyconfig()
    {
        ...
        $this->renderer->assign(ModUtil::getVar('Blocks'));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_admin_modifyconfig.htm');
    }
