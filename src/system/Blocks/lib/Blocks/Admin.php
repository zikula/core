...
class Blocks_Admin extends Zikula_Controller
{
    ...
    public function view()
    {
        ...
        $renderer->assign('blocks', $blocksitems);
        ...
        ksort($items);
        $renderer->assign('positions', $items);
        $renderer->assign('filter', $filter);

        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_view.htm');
    }
    ...
    public function modify()
    {
        ...
        if (!empty($modinfo['name'])) {
            $renderer->assign('modtitle', "$modinfo[name]/$blockinfo[bkey]");
        }

        // Add hidden block id to form
        $renderer->assign('bid', $bid);
        ...
        // assign the block
        $renderer->assign($blockinfo);

        // assign the list of modules
        $renderer->assign('mods', ModUtil::getAllMods());
        ...
        $renderer->assign('block_positions', $block_positions);
        ...
        // Block output
        $renderer->assign('blockoutput', $blockoutput);
        ...
        $renderer->assign($GLOBALS['blocks_modules'][$blockinfo['mid']][$blockinfo['bkey']]);
        ...
        $renderer->assign('blockrefreshtimes' , $refreshtimes);

        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_modify.htm');
    }
    ...
    public function newblock()
    {
        ...
        $renderer->assign('blockids', $blockinfo);
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_newblock.htm');
    }
    ...
    public function delete()
    {
        ...
        if (empty($confirmation)) {
            ...
            if (!empty($modinfo['name'])) {
                $renderer->assign('blockname', "$modinfo[name]/$blockinfo[bkey]");
            } else {
                $renderer->assign('blockname', "Core/$blockinfo[bkey]");
            }
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('blocks_admin_delete.htm');
        }
    ...
    public function newposition()
    {
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_newposition.htm');
    }
    ...
    public function modifyposition()
    {
        ...
        $renderer->assign('assignedblocks', $blocks);
        $renderer->assign('unassignedblocks', $allblocks);

        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_modifyposition.htm');
    }
    ...
    public function deleteposition($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            return $renderer->fetch('blocks_admin_deleteposition.htm');
        }
    ...
    public function modifyconfig()
    {
        ...
        $renderer->assign(ModUtil::getVar('Blocks'));

        // Return the output that has been generated by this function
        return $renderer->fetch('blocks_admin_modifyconfig.htm');
    }
