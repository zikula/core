...
class Blocks_Block_Lang extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $this->renderer->fetch('blocks_block_thelang.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        $this->renderer->clear_cache('blocks_block_thelang.htm');

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_block_thelang_modify.htm');
    }
