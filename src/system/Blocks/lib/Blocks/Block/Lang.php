...
class Blocks_Block_Lang extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $this->renderer->assign('urls', $urls);

        // get the block content from the template then end the templating
        $blockinfo['content'] = $this->renderer->fetch('blocks_block_thelang.tpl');
    ...
    public function modify($blockinfo)
    {
        ...
        $this->renderer->clear_cache('blocks_block_thelang.tpl');

        // Return the output that has been generated by this function
        return $this->renderer->fetch('blocks_block_thelang_modify.tpl');
    }
