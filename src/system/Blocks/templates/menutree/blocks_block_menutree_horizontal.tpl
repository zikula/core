<div class="menutree_horizontal_container">
    ...
    <ul class="menutree_horizontal_controls">
        ...
        <li><a href="{modurl modname=Blocks type=admin func=modify bid=$blockinfo.bid fromblock=1}" title="{gt text='Edit this block'"}">{img modname='core' set='icons' src='extrasmall/edit.gif' __alt='Edit this block' __title='Edit this block'}</a></li>
    </ul>
    {/if}
</div>
