    ...
    <li id="li_menuitemlist_{$itemid}" class="{cycle values='z-odd,z-even'} z-sortable z-clearfix">
        ...
        <div class="z-clearfix">
            ...
            <span class="z-itemcell z-w10">
                ...
                <button type="button" class="imagebutton-nofloat buttondelete" id="buttondelete_menuitemlist_{$itemid}">{img src='editdelete.gif' modname='core' set='icons/extrasmall' __alt='Delete' __title='Delete' }</button>
    ...
    <li id="menuitemlist_emptyitem" class="z-sortable z-clearfix" style="padding-left: 30px !important;">
        ...
        <div class="z-clearfix">
            ...
            <span class="z-itemcell z-w10">
                ...
                {if $thislanguage == $userlanguage}
                <button type="button" class="imagebutton-nofloat buttondelete" id="buttondelete_menuitemlist_X">{img src='editdelete.gif' modname='core' set='icons/extrasmall' __alt='Delete' __title='Delete' }</button>
