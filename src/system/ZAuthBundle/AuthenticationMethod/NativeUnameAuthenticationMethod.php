...
class NativeUnameAuthenticationMethod extends AbstractNativeAuthenticationMethod
{
    ...
    public function getLoginTemplateName(string $type = 'page', string $position = 'left'): string
    {
        if ('block' === $type) {
            if ('topnav' === $position) {
                return '@ZikulaZAuth/Authentication/UnameLoginBlock.topnav.html.twig';
            }

            return '@ZikulaZAuth/Authentication/UnameLoginBlock.html.twig';
        }

        return '@ZikulaZAuth/Authentication/UnameLogin.html.twig';
    }
