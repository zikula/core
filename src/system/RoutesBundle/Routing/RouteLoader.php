...
namespace Zikula\RoutesBundle\Routing;
...
use Zikula\RoutesBundle\Helper\ExtractTranslationHelper;
...
class RouteLoader extends Loader
{
    ...
    private function find(AbstractExtension $extension): array
    {
        ...
        foreach ($routeCollection as $oldRouteName => $route) {
            // set break here with $oldRouteName == 'zikula_routesbundle_route_renew'
     ...
     * See Zikula\RoutesBundle\Translation\ZikulaPatternGenerationStrategy
     */
    ...
    {
        return 'zikularoutesbundle' === $type;
    }
}
