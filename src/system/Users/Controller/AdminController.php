        ...
        if ($this->request->getMethod() == 'POST') {
            ...
            if (!$errorFields && !$validators->hasErrors()) {
                if ($originalUser['uname'] != $user['uname']) {
                    ...
                    $updatedUserObj = $this->entityManager->find('Users\Entity\UserEntity', $originalUser['uid']);
        ...
        if ($this->request->getMethod() == 'POST') {
            ...
            if (!$errorFields && !$validators->hasErrors()) {
                ...
                if ($originalRegistration['uname'] != $registration['uname']) {
                    ...
                    $updatedRegistrationObj = $this->entityManager->find('Users\Entity\UserEntity', $originalRegistration['uid']);
