...
{if $modvars.Users.moderation && ($modvars.Users.reg_verifyemail != 'Users\Constant::VERIFY_NO'|constant)}
    {if $modvars.Users.moderation_order == 'Users\Constant::APPROVAL_BEFORE'|constant}
...
{elseif $modvars.Users.reg_verifyemail != 'Users\Constant::VERIFY_NO'|constant}
...
{capture name='uname'}
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                {if ($authentication_method.modname != 'Users') || (($authentication_method.modname == 'Users') && ($modvars.Users.loginviaoption == 'Users\Constant::LOGIN_METHOD_EMAIL'|constant))}
...
{capture name='pass'}
        ...
        {else}
            <input id="{$formData->getFieldId('pass')}" name="pass" type="hidden" value="{'Users\Constant::PWD_NO_USERS_AUTHENTICATION'|constant}" />
            <input id="{$formData->getFieldId('passagain')}" name="passagain" type="hidden" value="{'Users\Constant::PWD_NO_USERS_AUTHENTICATION'|constant}" />
...
{capture name='email'}
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                {if (($authentication_method.modname == 'Users') && ($modvars.Users.loginviaoption == 'Users\Constant::LOGIN_METHOD_EMAIL'|constant))}
