...
<script type="text/javascript">
    Zikula.Users.Admin.Config.setup = function() {
        ...
        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ENABLED'|constant}}
        ...
        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_APPROVAL_REQUIRED'|constant}}
        ...
        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_AUTO_LOGIN'|constant}}
        Zikula.Users.Admin.Config.registrationAutoLoginWrapId = '{{$configData->getFieldId($fieldName)}}' + '_wrap';

        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_APPROVAL_SEQUENCE'|constant}}
        Zikula.Users.Admin.Config.registrationApprovalOrderWrapId = '{{$configData->getFieldId($fieldName)}}' + '_wrap';

        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_VERIFICATION_MODE'|constant}}
        Zikula.Users.Admin.Config.registrationVerificationModeId = '{{$configData->getFieldId($fieldName)}}';
        Zikula.Users.Admin.Config.registrationVerificationModeUserPwdId = '{{$configData->getFieldId($fieldName)}}' + '_' + '{{'Users\Constant::VERIFY_USERPWD'|constant}}';
        Zikula.Users.Admin.Config.registrationVerificationModeNoneId = '{{$configData->getFieldId($fieldName)}}' + '_' + '{{'Users\Constant::VERIFY_NO'|constant}}';

        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ANTISPAM_QUESTION'|constant}}
        Zikula.Users.Admin.Config.registrationAntispamQuestionId = '{{$configData->getFieldId($fieldName)}}';

        {{assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ANTISPAM_ANSWER'|constant}}
        Zikula.Users.Admin.Config.registrationAntispamAnswerMandatoryId = '{{$configData->getFieldId($fieldName)}}' + '_mandatory';

        {{assign var='fieldName' value='Users\Constant::MODVAR_LOGIN_METHOD'|constant}}
        ...
        {{assign var='fieldName' value='Users\Constant::MODVAR_REQUIRE_UNIQUE_EMAIL'|constant}}
...
<form class="z-form" id="{$configData->getFormId()}" action="{modurl modname='Users' type='admin' func='config'}" method="post">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ANONYMOUS_DISPLAY_NAME'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ITEMS_PER_PAGE'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_AVATAR_IMAGE_PATH'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_GRAVATARS_ENABLED'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_GRAVATAR_IMAGE'|constant}
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ACCOUNT_DISPLAY_GRAPHICS'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ACCOUNT_PAGE_IMAGE_PATH'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ACCOUNT_ITEMS_PER_PAGE'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_ACCOUNT_ITEMS_PER_ROW'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_MANAGE_EMAIL_ADDRESS'|constant}
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                <div id="{$configData->getFieldId($fieldName)}">
                    <input id="{$configData->getFieldId($fieldName)}_username" type="radio" name="{$fieldName}" value="{'Users\Constant::LOGIN_METHOD_UNAME'|constant}" {if ($configData->getFieldData($fieldName) < constant('Users\Constant::LOGIN_METHOD_EMAIL')) || ($configData->getFieldData($fieldName) > constant('Users\Constant::LOGIN_METHOD_ANY'))}checked="checked" {/if}/>
                    <label for="{$configData->getFieldId($fieldName)}_username">{gt text="User name"}</label>
                    <input id="{$configData->getFieldId($fieldName)}_email" type="radio" name="{$fieldName}" value="{'Users\Constant::LOGIN_METHOD_EMAIL'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::LOGIN_METHOD_EMAIL')}checked="checked" {/if}/>
                    <label for="{$configData->getFieldId($fieldName)}_email">{gt text="E-mail address"}</label>
                    <input id="{$configData->getFieldId($fieldName)}_either" type="radio" name="{$fieldName}" value="{'Users\Constant::LOGIN_METHOD_ANY'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::LOGIN_METHOD_ANY')}checked="checked" {/if}/>
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_PASSWORD_MINIMUM_LENGTH'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_HASH_METHOD'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_PASSWORD_STRENGTH_METER_ENABLED'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_EXPIRE_DAYS_CHANGE_EMAIL'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_EXPIRE_DAYS_CHANGE_PASSWORD'|constant}
        ...
        <fieldset>
            ...
            <div class="z-formrow" id="{$configData->getFieldId($fieldName)}_wrap">
                {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_DISABLED_REASON'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ADMIN_NOTIFICATION_EMAIL'|constant}
            ...
            <div class="z-formrow" id="{$configData->getFieldId($fieldName)}">
                ...
                <div class="z-formlist">
                    <input id="{$configData->getFieldId($fieldName)}_{'Users\Constant::VERIFY_USERPWD'|constant}" type="radio" name="{$fieldName}" value="{'Users\Constant::VERIFY_USERPWD'|constant}" {if ($configData->getFieldData($fieldName) == constant('Users\Constant::VERIFY_USERPWD')) || $configData->getFieldData($fieldName) == constant('Users\Constant::VERIFY_SYSTEMPWD')} checked="checked"{/if} />
                    <label for="{$configData->getFieldId($fieldName)}_{'Users\Constant::VERIFY_USERPWD'|constant}">{gt text="Yes. User chooses password, then activates account via e-mail"}</label>
                </div>
                <div class="z-formlist">
                    <input id="{$configData->getFieldId($fieldName)}_{'Users\Constant::VERIFY_NO'|constant}" type="radio" name="{$fieldName}" value="{'Users\Constant::VERIFY_NO'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::VERIFY_NO')} checked="checked"{/if}/>
                    <label for="{$configData->getFieldId($fieldName)}_{'Users\Constant::VERIFY_NO'|constant}">{gt text="No"}</label>
                </div>
                {if isset($errorFields.$fieldName)}<p class="z-formnote z-errormsg">{$errorFields.$fieldName}</p>{/if}
            </div>
            {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_AUTO_LOGIN'|constant}
            ...
            <div class="z-formrow" id="{$configData->getFieldId($fieldName)}_wrap">
                ...
                <div class="z-formlist">
                    <input id="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_BEFORE'|constant}" type="radio" name="{$fieldName}" value="{'Users\Constant::APPROVAL_BEFORE'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::APPROVAL_BEFORE')} checked="checked"{/if} />
                    <label for="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_BEFORE'|constant}">{gt text="Registration applications must be approved before users verify their e-mail address."}</label>
                </div>
                <div class="z-formlist">
                    <input id="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_AFTER'|constant}" type="radio" name="{$fieldName}" value="{'Users\Constant::APPROVAL_AFTER'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::APPROVAL_AFTER')} checked="checked"{/if} />
                    <label for="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_AFTER'|constant}">{gt text="Users must verify their e-mail address before their application is approved."}</label>
                </div>
                <div class="z-formlist">
                    <input id="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_ANY'|constant}" type="radio" name="{$fieldName}" value="{'Users\Constant::APPROVAL_ANY'|constant}" {if $configData->getFieldData($fieldName) == constant('Users\Constant::APPROVAL_ANY')} checked="checked"{/if} />
                    <label for="{$configData->getFieldId($fieldName)}_{'Users\Constant::APPROVAL_ANY'|constant}">{gt text="Application approval and e-mail address verification can occur in any order."}</label>
                </div>
                {if isset($errorFields.$fieldName)}<p class="z-formnote z-errormsg">{$errorFields.$fieldName}</p>{/if}
            </div>
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_EXPIRE_DAYS_REGISTRATION'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ILLEGAL_UNAMES'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ILLEGAL_AGENTS'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_REGISTRATION_ILLEGAL_DOMAINS'|constant}
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_LOGIN_WCAG_COMPLIANT'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_LOGIN_DISPLAY_INACTIVE_STATUS'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_LOGIN_DISPLAY_VERIFY_STATUS'|constant}
            ...
            <div class="z-formrow">
                {assign var='fieldName' value='Users\Constant::MODVAR_LOGIN_DISPLAY_APPROVAL_STATUS'|constant}
