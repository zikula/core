...
{if $approvalorder == 'Users::APPROVAL_AFTER'|constant}{gt text="We will not be able to approve your request until after you have completed this verification step."}{/if}
