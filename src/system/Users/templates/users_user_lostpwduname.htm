{gt text='Lost user name and password recovery' assign='templatetitle'}
...
<ul>
    <li><a href="{modurl modname='Users' type='user' func='lostuname'}">{gt text="I have forgotten my user name."}</a></li>
