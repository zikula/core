...
class Users_Admin extends Zikula_Controller
{
    ...
    public function newUser()
    {
        ...
        return $this->renderer->fetch('users_admin_newuser.tpl');
    }
    ...
    public function view($args = array())
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('users_admin_view.tpl');
    }
    ...
    public function search()
    {
        ...
        return $this->renderer->fetch('users_admin_search.tpl');
    }
    ...
    public function listUsers()
    {
        ...
        return $this->renderer->fetch('users_admin_listusers.tpl');
    }
    ...
    public function modify($args)
    {
        ...
        return $this->renderer->fetch('users_admin_modify.tpl');
    }
    ...
    public function deleteUsers($args)
    {
        ...
        // return output
        return $this->renderer->fetch('users_admin_deleteusers.tpl');
    }
    ...
    public function viewRegistrations()
    {
        ...
        return $this->renderer->fetch('users_admin_viewregistrations.tpl');
    }
    ...
    public function displayRegistration()
    {
        ...
        return $this->renderer->fetch('users_admin_displayregistration.tpl');
    }
    ...
    public function modifyRegistration()
    {
        ...
        $this->renderer->assign($rendererArgs);
        return $this->renderer->fetch('users_admin_modifyregistration.tpl');
    }
    ...
    public function verifyRegistration()
    {
        ...
        if (!FormUtil::getPassedValue('confirmed', false, 'GETPOST') || !SecurityUtil::confirmAuthKey('Users')) {
            ...
            return $this->renderer->fetch('users_admin_verifyregistration.tpl');
        } else {
    ...
    public function approveRegistration()
    {
        ...
        if (!FormUtil::getPassedValue('confirmed', false, 'GETPOST') || !SecurityUtil::confirmAuthKey('Users')) {
            ...
            return $this->renderer->fetch('users_admin_approveregistration.tpl');
        } else {
    ...
    public function denyRegistration()
    {
        ...
        if (!FormUtil::getPassedValue('confirmed', false, 'GETPOST') || !SecurityUtil::confirmAuthKey('Users')) {
            ...
            return $this->renderer->fetch('users_admin_denyregistration.tpl');
        } else {
    ...
    public function modifyConfig()
    {
        ...
        $this->renderer->assign('config', empty($config) ? $this->getVars() : $config)
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('users_admin_modifyconfig.tpl');
    }
    ...
    public function import($args)
    {
        ...
        return $this->renderer->fetch('users_admin_import.tpl');
    }
    ...
    public function exporter($args)
    {
        ...
        return $this->renderer->fetch('users_admin_export.tpl');
    }
