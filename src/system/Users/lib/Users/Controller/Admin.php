...
class Users_Controller_Admin extends Zikula_Controller
{
    ...
    public function newUser()
    {
        ...
        if (!empty($rendererArgs)) {
            ...
            $rendererArgs['usermustverify'] = ($this->options['reg_verify'] != UserUtil::VERIFY_NO) ? true : false;
        ...
        $rendererArgs['showprops'] = $profileModAvailable && isset($this->options['reg_optitems']) && $this->options['reg_optitems'];
    ...
    public function view($args = array())
    {
        ...
        $this->view->assign('pager', array('numitems'     => ModUtil::apiFunc('Users', 'user', 'countItems', array('letter' => $letter)),
                                               'itemsperpage' => $itemsperpage));

        // Assign the groups to the template
        $this->view->assign('allGroups', $groupsArray);

        // Inform to the template that user can see users' groups
        $this->view->assign('canSeeGroups', $canSeeGroups);
