...
class Users_Controller_FormData_RegistrationForm extends Users_Controller_FormData_AbstractFormData
{
    ...
    public function __construct($formId, Zikula_ServiceManager $serviceManager = null)
    {
        ...
        $this->addField(new Users_Controller_FormData_Field(
            ...
            ->addValidator(new Users_Controller_FormData_Validator_StringRegularExpression(
                $this->serviceManager,
                '/^'. Users::UNAME_VALIDATION_PATTERN .'$/uD',
        ...
        $passwordMinimumLength = (int)$this->getVar(Users::MODVAR_PASSWORD_MINIMUM_LENGTH, Users::DEFAULT_PASSWORD_MINIMUM_LENGTH);
        $this->addField(new Users_Controller_FormData_Field(
                $this,
                'pass',
                '',
        ...
        $this->addField(new Users_Controller_FormData_Field(
            ...
            ->addValidator(new Users_Controller_FormData_Validator_StringRegularExpression(
                $this->serviceManager,
                '/^'. Users::EMAIL_VALIDATION_PATTERN .'$/Di',
        ...
        $antispamQuestion = $this->getVar(Users::MODVAR_REGISTRATION_ANTISPAM_QUESTION, '');
        $this->addField(new Users_Controller_FormData_Field(
                $this,
                'antispamanswer',
                '',
    ...
    public function isValid()
    {
        ...
        if (!empty($antispamQuestion)) {
            $antispamAnswer = $this->getVar(Users::MODVAR_REGISTRATION_ANTISPAM_ANSWER, '');
