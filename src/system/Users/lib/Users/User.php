...
class Users_User extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        $this->renderer->assign('accountlinks', $accountlinks);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('users_user_main.htm');
    }
    ...
    public function loginScreen($args)
    {
        ...
        if (ModUtil::available('legal') && (ModUtil::getVar('legal', 'termsofuse') || ModUtil::getVar('legal', 'privacypolicy'))) {
            $this->renderer->assign('tou_active', ModUtil::getVar('legal', 'termsofuse', true))
    ...
    public function lostPwdUname()
    {
        ...
        return $this->renderer->fetch('users_user_lostpwduname.htm');
    }
    ...
    public function lostUname()
    {
        ...
        return $this->renderer->fetch('users_user_lostuname.htm');
    }
    ...
    public function lostPassword()
    {
        ...
        return $this->renderer->fetch('users_user_lostpassword.htm');
    }
    ...
    public function lostPasswordCode()
    {
        ...
        return $this->renderer->assign('lostpassword_uname', $uname)
                              ->assign('lostpassword_email', $email)
                              ->assign('lostpassword_code', $code)
                              ->fetch('users_user_lostpasswordcode.htm');
    }
    ...
    public function passwordReminder()
    {
        ...
        if (!isset($userInfo)) {
            ...
            return $this->renderer->assign('lostpassword_uname', $userInfo['uname'])
                                  ->assign('passreminder', $passwordReminder)
                                  ->assign('lostpassword_code', $code)
                                  ->fetch('users_user_passwordreminder.htm');
        }
    }
    ...
    public function verifyRegistration()
    {
        ...
        return $this->renderer->assign($rendererArgs)
                              ->fetch('users_user_verifyregistration.htm');
    }
    ...
    private function printRedirectPage($message, $url)
    {
        ...
        $this->renderer->assign('ThemeSel', System::getVar('Default_Theme'))
                       ->assign('url', $url)
                       ...
                       ->display('users_user_redirectpage.htm');
    ...
    public function usersBlock()
    {
        ...
        return $this->renderer->assign(UserUtil::getVars(UserUtil::getVar('uid')))
                              ->fetch('users_user_usersblock.htm');
    }
    ...
    public function changeEmail()
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('users_user_changeemail.htm');
    }
    ...
    public function changeLang()
    {
        ...
        $this->renderer->assign('languages', ZLanguage::getInstalledLanguageNames())
                       ->assign('usrlang', ZLanguage::getLanguageCode());

        // Return the output that has been generated by this function
        return $this->renderer->fetch('users_user_changelang.htm');
    }
