    ...
    <div>
        ...
        <fieldset>
            ...
            <ul class="systemrequirements">
                ...
                {if $checks.phpsatisfied}
                    <li><span class="fa fa-ok"></span> {gt text="Your PHP version is %s."  tag1=$phpversion}</li>
                {else}
                ...
                {if $checks.datetimezone}
                    <li><span class="fa fa-ok"></span> {gt text="php.ini: date.timezone is set to %s"  tag1=$checks.datetimezone}</li>
                {else}
                ...
                {if $checks.register_globals}
                    <li><span class="fa fa-ok"></span> {gt text="PHP register_globals = Off"}</li>
                {else}
                ...
                {if $checks.magic_quotes_gpc}
                    <li><span class="fa fa-ok"></span> {gt text="PHP magic_quotes_gpc = Off"}</li>
                {else}
                ...
                {if $checks.pdo}
                    <li><span class="fa fa-ok"></span> {gt text="PDO extension loaded."}</li>
                {else}
                ...
                {if $checks.phptokens}
                    <li><span class="fa fa-ok"></span> {gt text="Your PHP installation has the necessary token functions available."}</li>
                {else}
                ...
                {if $checks.mbstring}
                    <li><span class="fa fa-ok"></span> {gt text="Your PHP installation has the multi-byte string functions available."}</li>
                {else}
                ...
                {if $checks.pcreUnicodePropertiesEnabled}
                    <li><span class="fa fa-ok"></span> {gt text="Your PHP installation's PCRE library has Unicode property support enabled."}</li>
                {else}
                ...
                {if $checks.json_encode}
                    <li><span class="fa fa-ok"></span> {gt text="Your PHP installation has the JSON functions available."}</li>
                {else}
        ...
        <fieldset>
            ...
            <ul class="systemrequirements">
                ...
                <li><span class="fa fa-ok"></span> {gt text="'%s' is not present.  This is OK." tag1="config/personal_config.php"}</li>
                {else}
                ...
                <li><span class="fa fa-ok"></span> {gt text="'%s' is not present.  This is OK." tag1="app/config/custom_parameters.yml"}</li>
                {else}
        ...
        <fieldset>
            ...
            <ul class="systemrequirements">
              {foreach from=$files item="file"}
                {if $file.writable}
                <li><span class="fa fa-ok"></span> {gt text="%s is writeable." tag1=$file.filename}</li>
                {else}
