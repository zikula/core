...
var isBootstrapEvent=false;if(window.jQuery){jQuery("*").on("hide.bs.dropdown",function(e){isBootstrapEvent=true});jQuery("*").on("hide.bs.collapse",function(e){isBootstrapEvent=true});jQuery("*").on("hide.bs.modal",function(e){isBootstrapEvent=true});jQuery("*").on("hide.bs.popover",function(e){isBootstrapEvent=true});jQuery("*").on("hide.bs.tooltip",function(e){isBootstrapEvent=true})}
