<p>
    {if $guestcount eq 0}
    {gt text='%s user' plural='%s users' count=$userscount tag1=$userscount domain='zikula' assign='blockstring'}
    {gt text='%s on-line.' tag1=$blockstring domain='zikula'}
    {elseif $userscount eq 0}
    {gt text='%s anonymous' plural='%s anonymous guests' count=$guestcount tag1=$guestcount domain='zikula' assign='blockstring'}
    {gt text='%s on-line.' tag1=$blockstring domain='zikula'}
    {else}
    {gt text='%s user' plural='%s users' count=$userscount tag1=$userscount domain='zikula' assign='nummeb'}
    {gt text='%s anonymous' plural='%s anonymous guests' count=$guestcount tag1=$guestcount domain='zikula' assign='numanon'}
    {gt text='%1$s and %2$s' tag1=$nummeb tag2=$numanon domain='zikula'}
    {/if}
</p>
<!-- {if $loggedin eq 1}
    {if $msgmodule}
...
{else}
    {modurl modname=Users func=register assign=url}
