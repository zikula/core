...
<div class="z-form" style="margin-top:8px;">
    ...
    <fieldset>
        <legend>{gt text='New Extensions and Updates'}</legend>
            <ul>
                <li><a href="http://community.zikula.org/module-Extensions-view-comptype-1.htm">{gt text='Modules'}</a>			
				<li><a href="http://community.zikula.org/module-Extensions-view-comptype-2.htm">{gt text='Themes'}</a>
