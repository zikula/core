...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{lang}">
    <head>
        ...
        {pageaddvar name='stylesheet' value="$themepath/javascript/jquerymobile/jquery.mobile-1.3.0.min.css"}
        ...
        {pageaddvar name="javascript" value="$themepath/javascript/jquerymobile/jquery.mobile-1.3.0.min.js"}
