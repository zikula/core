 ...
 */
abstract class AbstractPlugin extends AbstractEventHandler implements TranslatableInterface
{
    /**
     ...
     *
     * Overriding the AbstractEventHandler interface which required this.
     *
     * <samp>
