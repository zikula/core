...
class AjaxInstallerStage implements StageInterface
{
    ...
    public function getTemplateParams()
    {
        return ['stages' => [
            ...
            18 => [
                self::NAME => 'pagelock',
                self::PRE => __('Zikula PageLock Module'),
                self::DURING => __('Installing Zikula PageLock Module'),
                self::SUCCESS => __('Zikula PageLock Module installed'),
                self::FAIL => __('There was an error installing Zikula PageLock Module')
            ],
            19 => [
