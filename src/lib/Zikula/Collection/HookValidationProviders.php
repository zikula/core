 ...
 */
class Zikula_Collection_HookValidationProviders extends Zikula_Collection_Container
{
    /**
     * Construct a new Zikula_Collection_HookValidationProviders.
     *
     ...
     */
    protected function set($name, Zikula_Provider_HookValidation $response)
    {
