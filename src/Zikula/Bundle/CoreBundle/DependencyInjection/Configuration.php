                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->scalarNode('page_title')
                                ->info('Page title. Possible tags: #pagetitle#, #sitename#.')
                            ...
                            ->end()
                            ->arrayNode('start_controller')
                                ->info('Start controller.')
                                ->children()
                                    ->scalarNode('route')
                                        ->info('Route name (e.g. acmefoobundle_person_display).')
                                        ->defaultNull()
                                    ->end()
                                    ->scalarNode('controller')
                                        ->info('Controller (e.g. AcmeFooBundle:Person:display).')
                                        ->defaultNull()
                                    ->end()
                                    ->scalarNode('query')
                                        ->info('GET parameters - Separate with &, for example: foo=2&bar=5.')
                                        ->defaultNull()
                                    ->end()
                                    ->scalarNode('attributes')
                                        ->info('Request attributes. Separate with &, for example: foo=2&bar=5.')
                                        ->defaultNull()
                                    ->end()
                                ->end()
                            ->end()
