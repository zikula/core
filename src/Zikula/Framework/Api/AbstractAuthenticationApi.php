 ...
 */
abstract class AbstractAuthenticationApi extends AbstractApi
{
    const FILTER_NONE = 0;
     ...
     *
     * @throws FatalException Thrown if invalid parameters are sent in $args.
     */
     ...
     *
     * @throws FatalException Thrown if the arguments array is invalid, or the user id, authentication method, or authentication information
     *                                      is invalid.
     */
     ...
     *
     * @throws FatalException Thrown if the authentication method does not support registration, or if the arguments array or any of the
     *                                  arguments are invalid.
     */
    public function checkPasswordForRegistration(array $args)
    {
        throw new FatalException($this->__('Registration authentication is not supported by this authentication method.'));
    }
