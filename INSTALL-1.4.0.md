...
Attention: If you have ``mod_suexec`` installed at Apache the CLI will run into permission problems. If you are not sure see phpinfo. mod_suexec often is used at shared hosting. In this case you have to use the Web Installer.
