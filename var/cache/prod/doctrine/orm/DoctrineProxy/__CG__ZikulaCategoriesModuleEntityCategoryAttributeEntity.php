 ...
 */
class CategoryAttributeEntity extends \Zikula\CategoriesModule\Entity\CategoryAttributeEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Zikula\\CategoriesModule\\Entity\\CategoryAttributeEntity' . "\0" . 'category', '' . "\0" . 'Zikula\\CategoriesModule\\Entity\\CategoryAttributeEntity' . "\0" . 'name', '' . "\0" . 'Zikula\\CategoriesModule\\Entity\\CategoryAttributeEntity' . "\0" . 'value', 'reflection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryAttributeEntity $proxy) {
