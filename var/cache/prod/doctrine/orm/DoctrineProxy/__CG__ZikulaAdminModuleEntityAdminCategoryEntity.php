 ...
 */
class AdminCategoryEntity extends \Zikula\AdminModule\Entity\AdminCategoryEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminCategoryEntity' . "\0" . 'cid', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminCategoryEntity' . "\0" . 'name', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminCategoryEntity' . "\0" . 'description', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminCategoryEntity' . "\0" . 'icon', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminCategoryEntity' . "\0" . 'sortorder', 'reflection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminCategoryEntity $proxy) {
