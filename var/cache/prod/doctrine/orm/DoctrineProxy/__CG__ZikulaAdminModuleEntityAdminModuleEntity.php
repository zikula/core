...
namespace DoctrineProxy\__CG__\Zikula\AdminModule\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AdminModuleEntity extends \Zikula\AdminModule\Entity\AdminModuleEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminModuleEntity' . "\0" . 'amid', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminModuleEntity' . "\0" . 'mid', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminModuleEntity' . "\0" . 'cid', '' . "\0" . 'Zikula\\AdminModule\\Entity\\AdminModuleEntity' . "\0" . 'sortorder', 'reflection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminModuleEntity $proxy) {
    ...
    public function getAmid(): ?int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAmid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAmid', []);

        return parent::getAmid();
    }
    ...
    public function setAmid(int $amid): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAmid', [$amid]);
