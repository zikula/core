...
namespace DoctrineProxy\__CG__\Zikula\ThemeModule\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ThemeEntity extends \Zikula\ThemeModule\Entity\ThemeEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'id', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'name', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'type', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'displayname', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'description', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'version', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'contact', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'admin', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'user', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'system', '' . "\0" . 'Zikula\\ThemeModule\\Entity\\ThemeEntity' . "\0" . 'state', 'reflection'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ThemeEntity $proxy) {
