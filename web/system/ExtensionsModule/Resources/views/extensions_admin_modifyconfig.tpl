...
<form class="z-form" action="{modurl modname="ExtensionsModule" type="admin" func="updateconfig"}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                <span><a id="restore_defaults" href="{modurl modname="ExtensionsModule" type="admin" func="view" defaults=true csrftoken=$csrftoken}">{gt text="Hard module regenerate to reset displayname, url and description to defaults"}</a></span>
            </div>
        </fieldset>
