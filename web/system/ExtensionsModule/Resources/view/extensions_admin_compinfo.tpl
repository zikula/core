...
<div class="z-buttons z-formbuttons">
    <a href="{modurl modname=ExtensionsModule type=admin func=view startnum=$startnum letter=$letter state=$state}">{img modname=core src=button_ok.png set=icons/small  __alt="Ok" __title="Ok"} {gt text="Ok"}</a>
</div>
{adminfooter}