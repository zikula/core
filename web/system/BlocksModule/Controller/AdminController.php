...
class AdminController extends \Zikula_AbstractController
{
    ...
    public function viewAction()
    {
        ...
        return $this->response($this->view->fetch('blocks_admin_view.tpl'));
    }
    ...
    public function modifyAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('blocks_admin_modify.tpl'));
    }
    ...
    public function newblockAction()
    {
        ...
        // Return the output that has been generated by this function
        $this->view->assign('block', $inputblock);
        
        return $this->response($this->view->fetch('blocks_admin_newblock.tpl'));
    }
    ...
    public function deleteAction()
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->response($this->view->fetch('blocks_admin_delete.tpl'));
        }
    ...
    public function newpositionAction()
    {
        ...
        return $this->response($this->view->fetch('blocks_admin_newposition.tpl'));
    }
    ...
    public function modifypositionAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('blocks_admin_modifyposition.tpl'));
    }
    ...
    public function deletepositionAction($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            return $this->response($this->view->fetch('blocks_admin_deleteposition.tpl'));
        }
    ...
    public function modifyconfigAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('blocks_admin_modifyconfig.tpl'));
    }
