...
<form class="z-form" action="{modurl modname=ThemeModule type=admin func=delete themename=$name|safetext}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
