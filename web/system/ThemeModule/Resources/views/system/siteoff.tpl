        ...
        <div id="container">
            <div id="cell">
                <div id="content">
                    ...
                    <h2><?php echo (\Zikula\Core\Core::VERSION_NUM != System::getVar('Version_Num')) ? __('This site needs to be upgraded, please contact the system administrator.') : System::getVar('siteoffreason');?></h2>
                    <p>
