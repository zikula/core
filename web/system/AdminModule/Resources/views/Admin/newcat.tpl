...
<form class="z-form" action="{modurl modname="AdminModule" type="admin" func="create"}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        <div class="z-buttons z-formbuttons">
            ...
            <a class="z-btblue" href="{modurl modname=AdminModule type=admin func=help fragment=new}" title="{gt text="Help"}">{img modname=core src=agt_support.png set=icons/extrasmall __alt="Help" __title="Help"} {gt text="Help"}</a>
        </div>
    </div>
</form>
{adminfooter}