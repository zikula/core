...
class Search_Controller_UserController extends Zikula_AbstractController
{
    ...
    public function formAction($vars = array())
    {
        ...
        if (count($search_modules) > 0) {
            ...
            return $this->response($this->view->fetch('search_user_form.tpl'));
        } else {
            // Create output object
            // Return the output that has been generated by this function
            return $this->response($this->view->fetch('search_user_noplugins.tpl'));
        }
    }
    ...
    public function searchAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('search_user_results.tpl'));
    }
    ...
    public function recentAction()
    {
        ...
        // Return the output that has been generated by this function
        return $this->response($this->view->fetch('search_user_recent.tpl'));
    }
}
