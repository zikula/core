...
{if $modvars.Users.moderation && ($modvars.Users.reg_verifyemail != 'UsersConstant::VERIFY_NO'|constant)}
    {if $modvars.Users.moderation_order == 'UsersConstant::APPROVAL_BEFORE'|constant}
...
{elseif $modvars.Users.reg_verifyemail != 'UsersConstant::VERIFY_NO'|constant}
...
{capture name='uname'}
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                {if ($authentication_method.modname != 'Users') || (($authentication_method.modname == 'Users') && ($modvars.Users.loginviaoption == 'UsersConstant::LOGIN_METHOD_EMAIL'|constant))}
...
{capture name='email'}
        <fieldset>
            ...
            <div class="z-formrow">
                ...
                {if (($authentication_method.modname == 'Users') && ($modvars.Users.loginviaoption == 'UsersConstant::LOGIN_METHOD_EMAIL'|constant))}
